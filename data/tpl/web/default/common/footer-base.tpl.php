	...
	<div class="container-fluid footer text-center" role="footer">	
		<div class="friend-link">
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?>
				<a href="http://wx.igdlrj.com">微信开发</a>
				<a>联系客服:18028571804</a>
			<?php  } else { ?>
				<?php  echo $_W['setting']['copyright']['footerright'];?>
			<?php  } ?>
		</div>
		<div class="copyright"><?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://wx.igdlrj.com"><b>优拓</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2019 <a href="http://wx.igdlrj.com">wx.igdlrj.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?></div>
