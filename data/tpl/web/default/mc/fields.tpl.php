...
<div class="panel panel-default">
	...
	<div class="panel-body table-responsive">
		...
		<tbody>
			<?php  if(is_array($account_member_fields)) { foreach($account_member_fields as $field) { ?>
			<tr>
				<td>
		...
		<div class="form-group">
			...
			<div class="col-sm-10 col-xs-12">
				<label for="radio_1" class="radio-inline">
					<input type="radio" name="available" id="radio_1" value="1" <?php  if(empty($field) || $field['available'] == 1) { ?> checked<?php  } ?> /> 是
				</label>
				<label for="radio_0" class="radio-inline">
					<input type="radio" name="available" id="radio_0" value="0" <?php  if(!empty($field) && $field['available'] == 0) { ?> checked<?php  } ?> /> 否
				</label>
			</div>
		</div>
		<div class="form-group">
