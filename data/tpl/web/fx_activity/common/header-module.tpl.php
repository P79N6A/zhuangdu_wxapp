<?php defined('IN_IA') or exit('Access Denied');?><?php  if(file_exists(IA_ROOT. "/addons/". $_W['current_module']['name']. "/icon-custom.jpg")) { ?>
...
<?php  if(!MERCHANTID) { ?>
<div class="pull-right related-info module-related-info"></div>
<script>
