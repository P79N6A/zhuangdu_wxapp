    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <p class='form-control-static'>
                <a href='javascript:;' class="js-clip" title='点击复制链接' data-url="<?php  echo mobileUrl('yoxrrshop.index.template_list',array(),1)?>" >
                    <?php  echo mobileUrl('yoxrrshop.index.template_list',array(),1)?>
                </a>
                <span style="cursor: pointer;" data-toggle="popover" data-trigger="hover" data-html="true"
                      data-content="<img src='<?php  echo m('qrcode')->createQrcode(mobileUrl('yoxrrshop.index.template_list',array(),1))?>'
