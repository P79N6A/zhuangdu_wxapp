    ...
    <form action="./index.php" method="get" class="form-horizontal table-search" role="form"  id="search">
        ...
        <div class="page-toolbar">
			...
			<span class="input-group-select">
                    <select name="audit_success" class="form-control" style="width:100px;padding:0 5px;">
                        <option value="" <?php  if($_GPC['audit_success']=='') { ?>selected<?php  } ?>>审核状态</option>
                        <option value="1" <?php  if($_GPC['audit_success'] == "0") { ?> selected="selected" <?php  } ?>>未审核</option>
						<option value="1" <?php  if($_GPC['audit_success'] == "1") { ?> selected="selected" <?php  } ?>>客服审核通过</option>
						<option value="1" <?php  if($_GPC['audit_success'] == "13") { ?> selected="selected" <?php  } ?>>客服审核不通过</option>
						<option value="1" <?php  if($_GPC['audit_success'] == "2") { ?> selected="selected" <?php  } ?>>财务审核通过</option>
						<option value="1" <?php  if($_GPC['audit_success'] == "23") { ?> selected="selected" <?php  } ?>>财务审核不通过</option>
						<option value="1" <?php  if($_GPC['audit_success'] == "3") { ?> selected="selected" <?php  } ?>>仓库审核通过</option>
						<option value="1" <?php  if($_GPC['audit_success'] == "33") { ?> selected="selected" <?php  } ?>>仓库审核不通过</option>
						<option value="1" <?php  if($_GPC['audit_success'] == "4") { ?> selected="selected" <?php  } ?>>物流审核通过</option>
						<option value="1" <?php  if($_GPC['audit_success'] == "43") { ?> selected="selected" <?php  } ?>>物流审核不通过</option>
                    </select>
                </span>
				<span class="input-group-select">
                    <select name="wechat_level" class="form-control" style="width:100px;padding:0 5px;">
                        <option value="" <?php  if($_GPC['wechat_level']=='') { ?>selected<?php  } ?>>代理等级</option>
                        <?php  if(is_array($level_list)) { foreach($level_list as $key => $level_info) { ?>
                        <option value="<?php  echo $level_info['level'];?>" <?php  if($_GPC['wechat_level'] == $level_info['level']) { ?> selected="selected" <?php  } ?>><?php  echo $level_info['name'];?></option>
                        <?php  } } ?>
                    </select>
                </span>
                <span class="input-group-select">
...
<span>当前状态:<?php  if($item['checked']==0) { ?>未处理<?php  } ?><?php  if($item['checked']==1) { ?>客服通过<?php  } ?><?php  if($item['checked']==13) { ?>客服不通过<?php  } ?><?php  if($item['checked']==2) { ?>财务通过<?php  } ?><?php  if($item['checked']==23) { ?>财务不通过<?php  } ?><?php  if($item['checked']==3) { ?>仓库通过<?php  } ?><?php  if($item['checked']==33) { ?>仓库不通过<?php  } ?><?php  if($item['checked']==4) { ?>物流通过<?php  } ?><?php  if($item['checked']==43) { ?>物流不通过<?php  } ?></span>
<a class="btn btn-primary btn-xs" data-toggle="ajaxPost" href="<?php  echo webUrl('order/op/audit_success', array('id' => $item['id'],'checked'=>1))?>" data-confirm="客服审核通过吗？">设置客服审核通过</a>
<a class="btn btn-primary btn-xs" data-toggle="ajaxPost" href="<?php  echo webUrl('order/op/audit_not_passed', array('id' => $item['id'],'checked'=>13))?>" data-confirm="客服审核不通过吗？">设置客服审核不通过</a>
<a class="btn btn-primary btn-xs" data-toggle="ajaxPost" href="<?php  echo webUrl('order/op/audit_success', array('id' => $item['id'],'checked'=>2))?>" data-confirm="财务审核通过吗？">设置财务审核通过</a>
<a class="btn btn-primary btn-xs" data-toggle="ajaxPost" href="<?php  echo webUrl('order/op/audit_not_passed', array('id' => $item['id'],'checked'=>23))?>" data-confirm="财务审核不通过吗？">设置财务审核不通过</a>
<a class="btn btn-primary btn-xs" data-toggle="ajaxPost" href="<?php  echo webUrl('order/op/audit_success', array('id' => $item['id'],'checked'=>3))?>" data-confirm="仓库审核通过吗？">设置客服审核通过</a>
<a class="btn btn-primary btn-xs" data-toggle="ajaxPost" href="<?php  echo webUrl('order/op/audit_not_passed', array('id' => $item['id'],'checked'=>33))?>" data-confirm="仓库审核不通过吗？">设置仓库审核不通过</a>
<a class="btn btn-primary btn-xs" data-toggle="ajaxPost" href="<?php  echo webUrl('order/op/audit_success', array('id' => $item['id'],'checked'=>4))?>" data-confirm="物流审核通过吗？">设置物流审核通过</a>
<a class="btn btn-primary btn-xs" data-toggle="ajaxPost" href="<?php  echo webUrl('order/op/audit_not_passed', array('id' => $item['id'],'checked'=>43))?>" data-confirm="物流审核不通过吗？">物流审核不通过</a>
