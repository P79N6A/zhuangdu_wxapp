...
<div class="page-content">
    ...
    "><i class='icow icow-help' style="font-size: 13px;color: #2f3434;margin-left: -3px"></i></a>
                    ...
                    <div class="col-md-12 ops">
                        ...
                        <a class="btn btn-primary" style="margin-left: 10px" href="<?php  echo webUrl('yoxwechatbusiness/order/logistics_list', array('order_id' => $item['id']))?>">打印发货订单</a><!--Yoper add-->
            ...
            <div class=" order-container-static">
                <div class=" status">
                    ...
                    <span class="text-default font18">无效</span>
                    <?php  } ?>
        ...
        overflow: hidden;text-overflow: ellipsis;"><?php  echo $goods['title'];?></a>
                    ...
                    <?php  } else { ?>
                        ...
                        <!--<td style="text-align: center;">
                            <a href="javascript:;" class="text-primary" hide="1"  data="<?php  echo $i;?>" onclick="order_split(this)">拆单</a>
                        </td>-->
                    <?php  } ?>
