	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<ul class="nav nav-tabs" id="selectUrlTab">
				...
				<?php  } ?>
				<?php  if($platform=='wxapp' && $type != 'topmenu' && $type != 'topmenu_data' && $type != 'levellink') { ?>
				<li class=""><a href="#sut_diypath">指定小程序路径</a></li>
				<?php  } ?>
				<?php  if($platform=='wxapp' && $type != 'topmenu' && $type != 'topmenu_data' && $type != 'levellink') { ?>
				...
				<li class=""><a href="#sut_diyxcx">其他小程序</a></li>
			...
			<div class="tab-content ">
				...
				<div class="tab-pane" id="sut_diypath" style="min-height: 100px;">
					<div class="row" style="margin: 100px 80px 80px;">
						<div class="input-group">
							<span class="input-group-addon">请输入小程序路径</span>
							<input type="text" placeholder="请输入已存在的小程序路径 例如：pages/index/index" id="select-diypath-kw" value="/pages/index/index" class="form-control">
							<span class="input-group-addon btn btn-primary select-btn" data-type="diypath">确认使用</span>
							<nav id="select-diy-path"></nav>
						</div>
						<div class="help-block text-danger">可加参数如：/pages/index/index?a=123 </div>
					</div>
				</div>
		...
		<script>
            ...
            $(function(){
                ...
                $(".select-btn").click(function(){
                    ...
                    if(type=='diypath'){
                        if(!kw || kw==''){
                            tip.msgbox.err("请输入小程序路径！");
                            return;
                        }
                        $('#select-diy-path').data('href', kw).trigger('click');
                        return;
                    }
                    if(type=='diyurl'){
