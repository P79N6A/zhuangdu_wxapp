...
<?php  } else if($type=='sns') { ?>
	...
	<?php  } else { ?>
		...
		<div class="line">
			<div class="icon icon-1"></div>
			<nav data-href="<?php  if($platform=='wxapp') { ?>/packageYoxsns/pages/sns/post?id=<?php  echo $item['id'];?><?php  } else { ?><?php  echo $item['url'];?><?php  } ?>" class="btn btn-default btn-sm" title="选择">选择</nav>
