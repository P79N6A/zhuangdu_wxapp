...
Page((_defineProperty(_Page = {
    ...
    MyCollectionShow: function() {
        var i = this;
        _request2.default.get("CollectionContentList", {}).then(function(t) {
            var a = [];
    ...
    CollectionL: function(t) {
        var e = this, i = t.currentTarget.dataset.index, a = t.currentTarget.id, n = 0, o = {
            types: "sz",
            id: a
        };
        _request2.default.post("operation", o).then(function(t) {
            for (var a in e.data.dataList[i].clstate = t.status, t.status ? e.data.dataList[i].clnb = parseInt(e.data.dataList[i].clnb) + 1 : e.data.dataList[i].clnb = parseInt(e.data.dataList[i].clnb) - 1, 
            e.data.dataList) n += e.data.dataList[a].clstate;
            0 == n && (e.data.dataNull = 0), e.setData({
                dataList: e.data.dataList,
                dataNull: e.data.dataNull
            });
        });
    },
    ...
    download: function(t) {
        ...
        wx.getSetting({
            success: function(t) {
                console.log(t), "img" == n ? a.downImg(e) : "video" == n && a.downVideo(e);
            }
        }), wx.setClipboardData({
    ...
    getDateDiff: function(t) {
        ...
        if (!(o < 0)) {
            ...
            if (1 <= s) if (parseInt(s) < 2) a = "昨天"; else {
                var l = n.getMonth() + 1 < 10 ? "0" + (n.getMonth() + 1) : n.getMonth() + 1, c = n.getDate() < 10 ? "0" + n.getDate() : n.getDate();
    ...
    _request2.default.get("CollectionContentList", e).then(function(t) {
