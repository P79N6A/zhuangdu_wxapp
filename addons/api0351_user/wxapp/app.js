...
App({
                ...
                o.code ? wx.getUserInfo({
                    success: function(e) {
                        util.request({
                            ...
                            cachetime: 30,
                            success: function(e) {
                                console.log(e.data.data.session_key), wx.setStorageSync("openid", e.data.data.openid), 
    ...
    tabBar: {
        ...
        list: [ {
            ...
            pagePath: "/api0351_user/pages/business/business",
            iconPath: "/api0351_user/resource/icon/category.png",
