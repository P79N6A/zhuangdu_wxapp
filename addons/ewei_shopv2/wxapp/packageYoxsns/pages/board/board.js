...
Page({
  ...
  touser: function(event) {
    ...
    console.log(openid)
    wx.navigateTo({
      url: './user?uid=' + uid + "&mainid=" + mainid + "&id=" + id+"&openid="+openid,
    })
  },
  ...
  getZhongcaoshe: function (id, title, searchvalue) {
    var that = this;
  ...
  onLoad: function(options) {
    ...
    that.getZhongcaoshe(options.id, options.title, options.searchValue);
    //console.log(options.title)
    that.setData({
      id: options.id
      //title: options.title
