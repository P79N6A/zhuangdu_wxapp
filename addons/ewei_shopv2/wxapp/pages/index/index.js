...
Page((e = {
  ...
  data: (a = {
      ...
      items: [
        ...
        // },
        {
          "pagePath": "../groups/index/index",
           // "pagePath": "/packageYoxwechatbusiness/pages/upgrade_goods/index/index",
  ...
  onLoad: function(t) {
    ...
    wx.getSetting({
        success: function(a) {
           var json=JSON.stringify(t);
            var auth = a.authSetting["scope.userInfo"];
            auth || wx.redirectTo({
                url: "/pages/message/auth/index?json="+JSON.stringify(json)
            });
            if (auth) {
              return false;
            }
    ...
    if (JSON.stringify(t) !== "{}") {
      ...
      if (inviteuid !== "") {
        s.get("yoxwechatbusiness/user/invited_result", { inviteuid: inviteuid, isajax: 1 }, function (e) {
