...
Page({
    ...
    getorderList:function(){
      var that=this;
      e.get("order.get_list", { isajax: 1, page: 1, comefrom:wxapp, openid:sns_wa_oWJzS5A6BOjOzLjiITdmMkMqYJf4 }, function (e) {
        that.setData({
        })
      })
    },
  toadd:function(){
    wx.navigateTo({
      url: '../../packageYoxwechatbusiness/pages/wechatbusinessuser/addorder/addorder',
    })
  }
});