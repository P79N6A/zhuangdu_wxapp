...
class Selecturl_EweiShopV2Page extends WebPage 
{
	...
	public function main() 
	{
		...
		//图文视频
		if(p("yoxarticlevideo")){
// 		    $allUrls[]=array('name'=>'图文视频','list'=>array(array('name'=>'图文视频主页','url'=>mobileUrl("yoxarticlevideo", NULL, $full),'url_wxapp'=>'/pages/ToArticlevideo/ToArticlevideo')));
		    $allUrls[]=array('name'=>'图文视频','list'=>array(array('name'=>'图文视频主页','url'=>mobileUrl("yoxarticlevideo", NULL, $full),'url_wxapp'=>'/packageYoxarticlevideo/pages/index')));
		}
		//diy模板
		if(p("yoxdiy")){
		...
		//朋友圈
		if(p("yoxfriendscircle")){
// 		    $allUrls[]=array('name'=>'朋友圈','list'=>array(array('name'=>'朋友圈主页','url'=>mobileUrl("yoxfirendscircle", NULL, $full),'url_wxapp'=>'/pages/ToFriendscircle/ToFriendscircle')));
		    $allUrls[]=array('name'=>'朋友圈','list'=>array(array('name'=>'朋友圈主页','url'=>mobileUrl("yoxfirendscircle", NULL, $full),'url_wxapp'=>'/packageYoxfriendscircle/pages/index')));
		}
		//微商
		if(p("yoxwechatbusiness")){
// 		    $allUrls[]=array('name'=>'微商','list'=>array(array('name'=>'微商主页','url'=>mobileUrl("yoxfirendscircle", NULL, $full),'url_wxapp'=>'/pages/ToFriendscircle/ToFriendscircle')));
		    $allUrls[]=array('name'=>'微商','list'=>array(array('name'=>'微商主页','url'=>mobileUrl("yoxfirendscircle", NULL, $full),'url_wxapp'=>'/pages/ToFriendscircle/ToFriendscircle'),array('name'=>'成分社','url'=>mobileUrl("yoxwechatbusiness/ingredients/product", NULL, $full),'url_wxapp'=>'/packageYoxwechatbusiness/pages/component/index')),);
		    
		}
		if(p("sns")){
// 		    $allUrls[]=array('name'=>'yox社区','list'=>array(array('name'=>'社区主页','url'=>mobileUrl("sns", NULL, $full),'url_wxapp'=>'/pages/ToYoxsns/Toindex')));
		    $allUrls[]=array('name'=>'yox社区','list'=>array(array('name'=>'社区主页','url'=>mobileUrl("sns", NULL, $full),'url_wxapp'=>'/packageYoxsns/pages/sns/index'),array('name'=>'板块','url_wxapp'=>'/packageYoxsns/pages/board/board'),array('name'=>'玩吧','url_wxapp'=>'/packageYoxsns/pages/wanba/wanba'),array('name'=>'美丽日记','url_wxapp'=>'/packageYoxsns/pages/meiliriji/meiliriji'),array('name'=>'种草社','url_wxapp'=>'/packageYoxsns/pages/zhongcaoshe/zhongcaoshe'),array('name'=>'投诉建议','url_wxapp'=>'/packageYoxsns/pages/tousujianyi/tousujianyi')));
		}
		...
		if( cv("sns.adv.edit") && p("sns") ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("sns"), "list" => array( array( "name" => "社区首页", "url" => mobileUrl("sns", NULL, $full), "url_wxapp" => "/packageYoxsns/pages/sns/index" ), array( "name" => "全部板块", "url" => mobileUrl("sns/board/lists", NULL, $full), "url_wxapp" => "/packageYoxsns/pages/sns/board/lists" ), array( "name" => "我的社区", "url" => mobileUrl("sns/user", NULL, $full), "url_wxapp" => "/packageYoxsns/pages/sns/user" ) ) );
		}
