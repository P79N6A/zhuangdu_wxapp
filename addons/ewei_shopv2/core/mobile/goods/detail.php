...
class Detail_EweiShopV2Page extends MobilePage 
{
	public function main() 
	{
		...
		else 
		{
			...
			$pligun_yoxwechatbusiness=p('yoxwechatbusiness');//
			if($pligun_yoxwechatbusiness){
			    $yoxwechatbusiness_level_list = $pligun_yoxwechatbusiness->level_list($_W['uniacid']);
			    $wechatbusiness_goods_field=$pligun_yoxwechatbusiness->goods_field($goods['id']);
			    $yoxwechatbusiness_price=$pligun_yoxwechatbusiness->goods_price($goods['id'],0,$_W['fans']['uid']);
