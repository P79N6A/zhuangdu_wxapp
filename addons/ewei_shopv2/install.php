...
-- ----------------------------
INSERT INTO `ims_ewei_shop_member_card` VALUES ('1', '1', '悟空源码社区', 'card-style-golden', '1', '1', '0', '0.0', '1', '0', '0', '0', 'a:0:{}', '0', '0', '0', 'a:0:{}', '-1', '240.00', '100', '0', '111', null, '1534976162', '0', '0', '0', '0');
...
CREATE TABLE `ims_ewei_shop_perm_log` (
  ...
  KEY `idx_createtime` (`createtime`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM AUTO_INCREMENT=1581 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of ims_ewei_shop_perm_log
-- ----------------------------
INSERT INTO `ims_ewei_shop_perm_log` VALUES ('1577', '1', '1', '小程序-底部导航-保存', 'app.tabbar.main', '保存底部导航', '113.64.81.56', '1532271937');
INSERT INTO `ims_ewei_shop_perm_log` VALUES ('1578', '1', '1', '小程序-底部导航-保存', 'app.tabbar.main', '保存底部导航', '113.64.81.56', '1532279193');
INSERT INTO `ims_ewei_shop_perm_log` VALUES ('1579', '1', '1', '付费会员卡(收费)-会员卡管理-添加', 'membercard.cardmanage.add', '添加会员卡 ID: 1  <br/>会员卡名称: 悟空源码社区', '183.24.172.232', '1534976163');
INSERT INTO `ims_ewei_shop_perm_log` VALUES ('1580', '1', '1', '付费会员卡(收费)-会员卡管理-启用/停发', 'membercard.cardmanage.status', '停发会员卡 ID: 1  <br/>会员卡名称: 悟空源码社区', '183.24.172.232', '1534976216');
...
INSERT INTO `ims_ewei_shop_plugin` VALUES ('48', '53', 'membercard', 'sale', '付费会员卡(悟空源码社区)', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/membercard.png', '', '0', '0', '1');
