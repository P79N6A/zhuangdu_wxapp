...
class Order_EweiShopV2Page extends PluginWebPage
{
	...
	public function detail()
	{
		...
		$order = pdo_fetch("SELECT o.*,g.title,g.category,op.option_name as optiontitle,g.groupsprice,g.singleprice,g.thumb,g.thumb_url,g.id as gid FROM " . tablename("ewei_shop_groups_order") . " as o\r\n\t\t\t\tleft join " . tablename("ewei_shop_groups_goods") . " as g on g.id = o.goodid\r\n\t\t\t\t\tleft join " . tablename("ewei_shop_groups_order_goods") . " as op on op.groups_order_id = o.id\r\n\t\t\t\tWHERE o.id = :orderid ", $params);
