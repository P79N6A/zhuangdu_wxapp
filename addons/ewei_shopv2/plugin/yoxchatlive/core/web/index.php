...
class Index_EweiShopV2Page extends PluginWebPage
{
    ...
    public function course_list(){
        ...
        //pdo_debug();
        include($this->template("yoxchatlive/index/course_list"));
    }
    public function course_edit()
    {
        ...
        $info = pdo_fetch("SELECT course.* FROM " . tablename('ewei_shop_yoxwechatbusiness_course') . " course ".
    ...
    public function course_message_list(){
        ...
        //pdo_debug();
        include($this->template("yoxchatlive/index/course_message_list"));
    }
