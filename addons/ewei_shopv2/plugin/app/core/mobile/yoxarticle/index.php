...
class Index_EweiShopV2Page extends AppMobilePage
{
	public function main() 
	{
		...
		$article["article_content"] = p("article")->mid_replace(htmlspecialchars_decode(m("common")->html_to_images($article["article_content"])));
	...
	public function share($params = array( )) 
	{
		...
		$shareid = intval($_GPC["shareid"]);
		$aid = intval($_GPC["aid"]);
		p("article")->doShare($aid, $shareid, $myid);
	}
