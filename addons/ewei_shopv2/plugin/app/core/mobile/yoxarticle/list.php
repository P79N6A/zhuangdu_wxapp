...
class List_EweiShopV2Page extends AppMobilePage
{
	public function main()
	{
		...
		$result['status']=1;
		$result['data']['article_sys']=$article_sys;
		$result['data']['list']=$categorys;
	...
	public function getlist()
	{
		...
		global $_GPC;
		//Yoper add
		$is_hot=$_GPC['is_hot']?$_GPC['is_hot']:0;//热门
		$is_featured=$_GPC['is_featured']?$_GPC['is_featured']:0;//精选
		...
		//Yoper add
		$is_hot && ($where=" AND is_hot=1 ");
		$is_featured && ($where.=" AND is_featured=1 ");
