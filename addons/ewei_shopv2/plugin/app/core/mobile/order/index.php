...
class Index_EweiShopV2Page extends AppMobilePage
{
	...
	public function get_list()
	{
		...
		// echo "select id,ordersn,price,userdeleted,isparent,refundstate,paytype,status,addressid,refundid,isverify,dispatchtype,verifytype,verifyinfo,verifycode,iscomment,iscycelbuy,verified from " . tablename("ewei_shop_order") . " where 1 " . $condition . " order by createtime desc";die();
