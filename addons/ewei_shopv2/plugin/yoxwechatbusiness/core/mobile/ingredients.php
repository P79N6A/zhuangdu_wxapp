...
class Ingredients_EweiShopV2Page extends PluginMobilePage 
{
    //列表
	...
	public function product(){
        ...
        include($this->template('yoxwechatbusiness/ingredients/product'));
    }
    /**
     * 成分列表
     */
    public function ingredient(){
        ...
        include($this->template('yoxwechatbusiness/ingredients/ingredient'));
    }
    /**
     * 相同成分的产品
     */
    public function page_same_ingredient_goods_list(){
        ...
        include($this->template('yoxwechatbusiness/ingredients/same_ingredient_goods_list'));
    }
    /**
     * 成分列表
     */
