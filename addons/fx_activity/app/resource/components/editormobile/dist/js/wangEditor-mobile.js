...
window.___E_mod(function (E, $) {
	...
	E.config = {
		...
		happy: [
			...
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/a5/hb_fahongbao2016_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/65/hb_qiangdao2016_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c8/lxhzuiyou_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/64/lxhtongku_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/67/gangnamstyle_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/fa/lxhtouxiao_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/03/lxhjiayou_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/b6/doge_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/4a/mm_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/34/xiaoku_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/f4/xklzhuanquan_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/ee/mango_03_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/64/mango_07_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/5c/mango_12_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/9f/mango_02_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/49/mango_11_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/cc/yangniandj_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6b/watermelon.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c0/football.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/46/mothersday_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/36/carnation_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/e5/soap_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/e6/youqian_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/dc/earth1r_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/dc/flag_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/87/lxhxuyuan_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/92/fan.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/f4/zhaji_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/00/snow_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/ee/mashangyouduixiang_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/30/madaochenggong_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/f8/hongyun_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/0b/hongbaofei2014_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/20/alizuoguiliannew_thumb.gif',
			'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/de/aliwanew_thumb.gif'
		],
...
window.___E_mod(function (E, $) {
	...
	E.fn.addTxt = function () {
		...
		var $txt = $(
			'<div contenteditable="true" class="wangEditor-mobile-txt'+(val.length==0?' placeholder':'')+'" placeholder="在此输入图文详情...">' + val + '</div>'
		);
...
window.___E_mod(function (E, $) {
	...
	E.fn.addMenuColor = function (menuId) {
		...
		var menus = self.menus;		
		var $body = self.$body;
		var ColorArr = self.config.menuColorValue;
		var $txt = self.$txt;
		...
		menus[menuId] = {
			...
			renderModal: function () {
				...
				var itemTpl = '<span class="command-color" commandValue="#{Color}" style="background-color:#{Color}">&nbsp;</span>';
				var contentHtmlArr = [];

				// 拼接数据
				$.each(ColorArr, function (key, value) {
					contentHtmlArr.push(
						itemTpl.replace(/#{Color}/ig, value)
					);
				});
				$modal.append('<span class="command-color" commandValue="" style="background-color: #ccc;">无</span>'+contentHtmlArr.join(''));
				...
				// 绑定表情图标的事件
				$modal.on('click', '.command-color', function (e) {
					// 屏蔽click事件的默认行为
					e.preventDefault();
				});
				$modal.on('singleTap', '.command-color', function (e) {
					if (self.checkTapTime(e, 'happy command-color') === false) {
						return;
					}

					var $commandcolor = $(e.currentTarget);
					var commandValue = $commandcolor.attr('commandValue');
					
					if (commandValue=='') {
						commandValue='#333';
					}
					// 执行命令
					self.command('forecolor', false, commandValue, e);
		...
		menus[menuId] = {
			...
			renderModal: function () {
				...
				$modal.on('singleTap', '.command-link', function (e) {
					...
					//self.command('Insert', false, '<img src="' + commandValue +'" width="22" height="22">', e);
					document.execCommand('inserthtml',  false, '<img src="' + commandValue +'" style="width: 20px;height: 20px;">', e);
					// 隐藏 modal
					menuData.hideModal();
				});
			},
				...
				$inputFlie.on('change', function (e) {
					...
					reader.onload = function(e){
						...
						if (window.URL && window.URL.createObjectURL) {
							...
							// 生成预览图片，设置半透明
							var fn = function () {
								self.$focusElem.after('<div class="previmg-container" id="' + prveImgContainerId + '">' + 
						...
						console.log('生成预览图片，src是：' + prevImgSrc);
			            ...
			            function timeoutCallback() {
			            	...
			            	if (location.hostname.toLowerCase() === 'wangeditor.github.io') {
			            		// 官网demo的特殊提示
			            		alert('提示：wangEditor官网demo没有后台服务，因此超时（该alert在实际活动中不会出现）');
			            	}
			            }
			            ...
			            xhr.onload = function () {
			            	...
			            	var resultSrc = getData.url; //服务器端要返回图片url地址
			            	var erroInfo;
			            	var $prevImgContainer = $('#' + prveImgContainerId);
			            	var loadImg;
			            	var $loadImg;
			            	...
			            	if (resultSrc.indexOf('error|') === 0) {
			            		...
			            		log('准备下载该图片...');
								//更新附件信息id
			            		//$.post('../app/index.php?i=' + util.querystring("i") + '&c=entry&m=fx_activity&do=utility&ac=file&op=upload',{attachid:getData.id});
			            		// 下载图片，下载完成后赋值到编辑器中
						...
						function compress(img) {
							...
							img.onload = function(){
								...
								var ratio;
								if ((ratio = width * height / 409600)>1) {
								...
								//如果图片像素大于100万则使用瓦片绘制
								var count;
								if ((count = width * height / 409600) > 1) {
								...
								//进行最小压缩
								var ndata = canvas.toDataURL(fileType, 0.7);
								...
								// 2. file 要和后台一致
								//var fileData = new File([convertBase64UrlToBlob(ndata, fileType)], fileName);
								formData.append('file', convertBase64UrlToBlob(ndata, fileType));
								formData.append("name", '图文：'+fileName);
								xhr.send(formData);
							}
						}
					};
	...
	E.fn.bindTxtEvent = function () {
		...
		$txt.on('keydown', function (e) {
			...
			if (e.keyCode === 8 && /^<(\w+)[^<>]*><br><\/\1>$/.test(html)) {
				...
				$('.wangEditor-mobile-txt').addClass('placeholder');
				e.preventDefault();
			}else{
...
// center 居中
window.___E_mod(function (E, $) {
	E.fn.addMenuCenter = function (menuId) {
		var self = this;
		var menus = self.menus;
		...
		menus[menuId] = {
			...
			// 触发器
			$trigger: $('<div><i class="icon-wangEditor-m-justify-center"></i></div>'),
			// 包裹触发器的容器
			$wrap: $('<div class="item"></div>'),
			...
			bindEvent: function (editor) {
				var menuData = this;
				menuData.$trigger.on('singleTap', function (e) {
					if (self.checkTapTime(e, 'center') === false) {
						return;
					}
					...
					if (!menuData.selected) {
						...
						self.$focusElem.removeClass('focus-elem');
						// 执行命令
						self.command('justifyCenter', false, undefined, e);
					}else{
						self.command('justifyLeft', false, undefined, e);
					}
