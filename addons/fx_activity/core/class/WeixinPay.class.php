...
//查询退款
	...
	public function wxHttpsRequestPem($vars,$url, $second=30,$aHeader=array()) {
		...
		if ($_W['_config']['sys_refund']==2) {
			curl_setopt($ch,CURLOPT_SSLCERTTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLCERT,IA_ROOT . '/attachment/'.MODULE_NAME.'/cert/' . $_W['uniacid'] . '/apiclient_cert.pem');
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY,IA_ROOT . '/attachment/'.MODULE_NAME.'/cert/' . $_W['uniacid'] . '/apiclient_key.pem');
		}else{
			curl_setopt($ch,CURLOPT_SSLCERTTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLCERT,IA_ROOT . '/attachment/'.MODULE_NAME.'/cert/' . $_W['uniacid'] . '/apiclient_cert.pem');
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			...
			//curl_setopt($ch,CURLOPT_CAINFO,IA_ROOT . '/attachment/'.MODULE_NAME.'/cert/' . $_W['uniacid'] . '/rootca.pem');
		}
		if( count($aHeader) >= 1 )
		{
