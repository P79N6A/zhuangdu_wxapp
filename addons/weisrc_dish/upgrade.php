...
`is_notice_queue` tinyint(1) NOT NULL DEFAULT '1',
...
`weid` int(10) unsigned NOT NULL,
`from_user` varchar(100) COMMENT '用户ID',
...
`ordersn` varchar(100),
`from_user` varchar(100) COMMENT '购买者openid',
...
`thumb` varchar(500) NOT NULL COMMENT '图片',
...
`credittype` varchar(100) COMMENT '积分类型',
`num` decimal(10,2) DEFAULT '0.00',
`operator` varchar(100),
`remark` varchar(1000) COMMENT '内容',
`dateline` int(10) unsigned NOT NULL DEFAULT '0',
PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ims_weisrc_dish_deliverytime` (
`id` int(10) NOT NULL AUTO_INCREMENT,
`weid` int(10) unsigned NOT NULL,
`storeid` int(10) unsigned NOT NULL,
...
`email_host` varchar(50) COMMENT '邮箱服务器',
`email_send` varchar(100),
`email_pwd` varchar(20) COMMENT '邮箱密码',
`email_user` varchar(100) COMMENT '发信人名称',
`email` varchar(100),
`email_business_tpl` varchar(200) COMMENT '商户接收内容模板',
`dateline` int(10) DEFAULT '0',
PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
`from_user` varchar(50) COMMENT '用户ID',
`nickname` varchar(50),
...
`content` varchar(500) COMMENT '回复内容',
...
`open_order_code` varchar(200) COMMENT '蜂鸟配送开放平台返回的订单号',
`partner_order_code` varchar(200) COMMENT '商户自己的订单号',
`order_status` int(11) DEFAULT '0' COMMENT '状态码',
`push_time` int(11) DEFAULT '0' COMMENT '状态推送时间(毫秒)',
`carrier_driver_name` varchar(200) COMMENT '蜂鸟配送员姓名',
`carrier_driver_phone` varchar(200) COMMENT '蜂鸟配送员电话',
`description` varchar(200) COMMENT '描述信息',
`address` varchar(200) COMMENT '定点次日达服务独有的字段: 微仓地址',
...
`error_code` varchar(200) COMMENT '错误编码',
PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
`taste` varchar(1000) NOT NULL COMMENT '口味',
...
`memberprice` varchar(10) NOT NULL COMMENT '会员价',
`lasttime` int(10) NOT NULL DEFAULT '0',
`deleted` tinyint(1) unsigned NOT NULL DEFAULT '0',
`counts` int(10) NOT NULL DEFAULT '-1',
`sales` int(10) unsigned NOT NULL DEFAULT '0',
`today_counts` int(10) NOT NULL DEFAULT '0',
`packvalue` varchar(10) NOT NULL DEFAULT '0' COMMENT '打包费',
`content` text,
...
`content` varchar(1000) NOT NULL COMMENT '菜品',
`displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
`enabled` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否开启',
PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
`link` varchar(200) NOT NULL COMMENT '导航链接',
`displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
...
`totalnum` tinyint(4) COMMENT '总数量',
...
`reply` varchar(1000) NOT NULL COMMENT '回复',
`meal_time` varchar(50) NOT NULL COMMENT '就餐时间',
...
`remark` varchar(1000) NOT NULL COMMENT '备注',
`tables` varchar(10) NOT NULL COMMENT '桌号',
...
`paydetail` varchar(1000) NOT NULL COMMENT '消费详细信息',
...
`tablezonesid` varchar(10) NOT NULL COMMENT '桌台类别',
`delivery_id` int(10) NOT NULL DEFAULT '0' COMMENT '配送员id',
...
`newlimitprice` varchar(500) NOT NULL,
`oldlimitprice` varchar(500) NOT NULL,
`newlimitpricevalue` varchar(10) NOT NULL,
`oldlimitpricevalue` varchar(10) NOT NULL,
...
`member_code` varchar(100) COMMENT '商户代码',
`feyin_key` varchar(100) COMMENT 'api密钥',
...
`storeid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '门店编号',
`from_user` varchar(100),
`savenumber` varchar(100) NOT NULL COMMENT '存酒卡号',
`title` varchar(200) COMMENT '物品名称',
...
`id` int(10) NOT NULL AUTO_INCREMENT,
`weid` int(10) unsigned NOT NULL,
`title` varchar(50) COMMENT '网站名称',
`thumb` varchar(200) COMMENT '背景图',
`storeid` int(10) unsigned NOT NULL DEFAULT '0',
...
`tplneworder` varchar(200) COMMENT '模板id',
`tpluser` text COMMENT '通知用户',
`searchword` varchar(1000) COMMENT '搜索关键字',
`tplboss` varchar(200) NOT NULL,
...
`tploperator` varchar(200) COMMENT '模板id',
...
`tplnewqueue` varchar(200) COMMENT '模板id',
...
`sms_username` varchar(20) COMMENT '平台帐号',
`sms_pwd` varchar(20) COMMENT '平台密码',
`sms_mobile` varchar(20) COMMENT '商户接收短信手机',
`email_enable` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '开启邮箱提醒',
`email_host` varchar(50) COMMENT '邮箱服务器',
`email_send` varchar(100) COMMENT '商户发送邮件邮箱',
`email_pwd` varchar(20) COMMENT '邮箱密码',
`email_user` varchar(100) COMMENT '发信人名称',
`email` varchar(100) COMMENT '商户接收邮件邮箱',
`tplapplynotice` varchar(200) NOT NULL,
`link_recharge` varchar(500),
`link_recharge_name` varchar(100),
...
`follow_title` varchar(500),
`follow_desc` varchar(500),
`follow_logo` varchar(500),
...
`tipqrcode` varchar(500),
`statistics` text NOT NULL,
`delivery_cash_price` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '提现最低金额',
`fengniao_appid` varchar(200),
`fengniao_key` varchar(200),
`is_verify_mobile` tinyint(1) NOT NULL DEFAULT '0',
`dayu_appkey` varchar(200),
`dayu_secretkey` varchar(200),
`dayu_verify_code` varchar(200),
`dayu_sign` varchar(200),
`fengniao_mode` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1:正式启用;2:调试阶段',
`commission_keywords` varchar(200),
...
`tplmission` varchar(200) COMMENT '模板id',
`style_base` varchar(20) NOT NULL DEFAULT '#3190e8',
`style_list_btn1` varchar(20) NOT NULL DEFAULT '#6a3f34',
`style_list_btn2` varchar(20) NOT NULL DEFAULT '#a57664',
`style_list_btn3` varchar(20) NOT NULL DEFAULT '#9995a3',
`style_list_base` varchar(20) NOT NULL DEFAULT '#FE4F4E',
...
`checkcode` varchar(100) COMMENT '验证码',
...
`sms_pwd` varchar(20) COMMENT '平台密码',
`sms_mobile` varchar(20) COMMENT '商户接收短信手机',
`sms_verify_tpl` varchar(120) COMMENT '验证短信模板',
`sms_business_tpl` varchar(120) COMMENT '商户短信模板',
`sms_user_tpl` varchar(120) COMMENT '用户短信模板',
`dateline` int(10) DEFAULT '0',
PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
`logo` varchar(500) NOT NULL COMMENT '商家logo',
...
`hours` varchar(200) NOT NULL COMMENT '营业时间',
...
`sendingprice` varchar(10) NOT NULL COMMENT '起送价格',
...
`freeprice` decimal(10,2) DEFAULT '0.00',
`begintime` varchar(20) DEFAULT '09:00' COMMENT '开始时间',
`announce` varchar(1000) NOT NULL COMMENT '通知',
`endtime` varchar(20) DEFAULT '18:00' COMMENT '结束时间',
...
`from_user` varchar(200) NOT NULL,
`delivery_within_days` int(10) NOT NULL DEFAULT '0',
...
`coupon_title1` varchar(100) NOT NULL COMMENT '优惠名称',
`coupon_title2` varchar(100) NOT NULL COMMENT '优惠名称',
`coupon_title3` varchar(100) NOT NULL COMMENT '优惠名称',
`coupon_link1` varchar(200) NOT NULL COMMENT '优惠名称',
`coupon_link2` varchar(200) NOT NULL COMMENT '优惠名称',
`coupon_link3` varchar(200) NOT NULL COMMENT '优惠名称',
`qq` varchar(20) NOT NULL,
`weixin` varchar(20) NOT NULL,
`business_type` tinyint(1) NOT NULL DEFAULT '0',
`business_openid` varchar(200) NOT NULL,
`business_username` varchar(200) NOT NULL,
`business_alipay` varchar(200) NOT NULL,
`business_wechat` varchar(200) NOT NULL,
`is_reservation_today` tinyint(1) NOT NULL DEFAULT '1',
`reservation_tip` varchar(200) NOT NULL DEFAULT '请输入备注，人数口味等等（可不填）',
`is_ld_wxserver` tinyint(1),
`is_locktables` tinyint(1) NOT NULL DEFAULT '0',
`ld_wxserver_url` varchar(255),
...
`jueqi_host` varchar(200) NOT NULL,
`jueqi_customerId` varchar(200) NOT NULL,
...
`vtiny_bankpay_url` varchar(500) NOT NULL COMMENT '链接',
...
`business_mobile` varchar(30) NOT NULL,
`jueqi_secret` varchar(200) NOT NULL,
...
`btn_coupon_url` varchar(500) NOT NULL,
...
`storeid` int(10) unsigned NOT NULL DEFAULT '0',
`tablezonesid` int(10) unsigned NOT NULL DEFAULT '0',
`title` varchar(200) NOT NULL COMMENT '名字(桌台号)',
...
`orderid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '订单编号',
`ordersn` varchar(100),
`from_user` varchar(100) COMMENT '接收者openid',
`content` varchar(1000) COMMENT '内容',
`result` varchar(200) COMMENT '内容结果',
`dateline` int(10) DEFAULT '0',
PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
`mobile` varchar(20) NOT NULL,
`address` varchar(300) NOT NULL,
`doorplate` varchar(300) NOT NULL,
...
");
if(pdo_tableexists('weisrc_dish_account')) {
...
if(pdo_tableexists('weisrc_dish_account')) {
	if(!pdo_fieldexists('weisrc_dish_account',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_account')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_account')) {
	if(!pdo_fieldexists('weisrc_dish_account',  'uid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_account')." ADD `uid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_account')) {
...
if(pdo_tableexists('weisrc_dish_account')) {
	if(!pdo_fieldexists('weisrc_dish_account',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_account')." ADD `displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
	}	
}
if(pdo_tableexists('weisrc_dish_account')) {
	if(!pdo_fieldexists('weisrc_dish_account',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_account')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_account')) {
	if(!pdo_fieldexists('weisrc_dish_account',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_account')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_account')) {
...
if(pdo_tableexists('weisrc_dish_account')) {
	if(!pdo_fieldexists('weisrc_dish_account',  'is_notice_queue')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_account')." ADD `is_notice_queue` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_account')) {
	if(!pdo_fieldexists('weisrc_dish_account',  'accountname')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_account')." ADD `accountname` varchar(50) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_account')) {
	if(!pdo_fieldexists('weisrc_dish_account',  'password')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_account')." ADD `password` varchar(200) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_account')) {
	if(!pdo_fieldexists('weisrc_dish_account',  'salt')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_account')." ADD `salt` varchar(10) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_account')) {
...
if(pdo_tableexists('weisrc_dish_account')) {
	if(!pdo_fieldexists('weisrc_dish_account',  'remark')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_account')." ADD `remark` varchar(1000) NOT NULL COMMENT '备注';");
	}	
}
if(pdo_tableexists('weisrc_dish_account')) {
...
if(pdo_tableexists('weisrc_dish_ad')) {
...
if(pdo_tableexists('weisrc_dish_ad')) {
	if(!pdo_fieldexists('weisrc_dish_ad',  'position')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_ad')." ADD `position` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1:首页,2:商家页';");
	}	
}
if(pdo_tableexists('weisrc_dish_ad')) {
	if(!pdo_fieldexists('weisrc_dish_ad',  'starttime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_ad')." ADD `starttime` int(10) NOT NULL DEFAULT '0' COMMENT '开始时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_ad')) {
	if(!pdo_fieldexists('weisrc_dish_ad',  'endtime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_ad')." ADD `endtime` int(10) NOT NULL DEFAULT '0' COMMENT '结束时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_ad')) {
	if(!pdo_fieldexists('weisrc_dish_ad',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_ad')." ADD `displayorder` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_ad')) {
	if(!pdo_fieldexists('weisrc_dish_ad',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_ad')." ADD `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否显示';");
	}	
}
if(pdo_tableexists('weisrc_dish_ad')) {
...
if(pdo_tableexists('weisrc_dish_address')) {
...
if(pdo_tableexists('weisrc_dish_address')) {
	if(!pdo_fieldexists('weisrc_dish_address',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_address')." ADD `dateline` int(10) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_area')) {
...
if(pdo_tableexists('weisrc_dish_area')) {
	if(!pdo_fieldexists('weisrc_dish_area',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_area')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_area')) {
	if(!pdo_fieldexists('weisrc_dish_area',  'name')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_area')." ADD `name` varchar(50) NOT NULL COMMENT '区域名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_area')) {
	if(!pdo_fieldexists('weisrc_dish_area',  'parentid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_area')." ADD `parentid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '上级分类ID,0为第一级';");
	}	
}
if(pdo_tableexists('weisrc_dish_area')) {
	if(!pdo_fieldexists('weisrc_dish_area',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_area')." ADD `displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
	}	
}
if(pdo_tableexists('weisrc_dish_area')) {
	if(!pdo_fieldexists('weisrc_dish_area',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_area')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_area')) {
	if(!pdo_fieldexists('weisrc_dish_area',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_area')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_blacklist')) {
...
if(pdo_tableexists('weisrc_dish_blacklist')) {
	if(!pdo_fieldexists('weisrc_dish_blacklist',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_blacklist')." ADD `from_user` varchar(100) COMMENT '用户ID';");
	}	
}
if(pdo_tableexists('weisrc_dish_blacklist')) {
	if(!pdo_fieldexists('weisrc_dish_blacklist',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_blacklist')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_blacklist')) {
	if(!pdo_fieldexists('weisrc_dish_blacklist',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_blacklist')." ADD `dateline` int(10) DEFAULT '0' COMMENT '创建时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_businesslog')) {
...
if(pdo_tableexists('weisrc_dish_businesslog')) {
	if(!pdo_fieldexists('weisrc_dish_businesslog',  'price')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `price` decimal(10,2) DEFAULT '0.00' COMMENT '申请金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_businesslog')) {
	if(!pdo_fieldexists('weisrc_dish_businesslog',  'haveprice')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `haveprice` decimal(10,2) DEFAULT '0.00' COMMENT '已申请总金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_businesslog')) {
	if(!pdo_fieldexists('weisrc_dish_businesslog',  'totalprice')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `totalprice` decimal(10,2) DEFAULT '0.00' COMMENT '当时可总金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_businesslog')) {
...
if(pdo_tableexists('weisrc_dish_businesslog')) {
	if(!pdo_fieldexists('weisrc_dish_businesslog',  'charges')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `charges` decimal(10,2) DEFAULT '0.00' COMMENT '手续费';");
	}	
}
if(pdo_tableexists('weisrc_dish_businesslog')) {
	if(!pdo_fieldexists('weisrc_dish_businesslog',  'successprice')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_businesslog')." ADD `successprice` decimal(10,2) DEFAULT '0.00' COMMENT '到帐金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_businesslog')) {
...
if(pdo_tableexists('weisrc_dish_cart')) {
...
if(pdo_tableexists('weisrc_dish_cart')) {
	if(!pdo_fieldexists('weisrc_dish_cart',  'goodstype')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_cart')." ADD `goodstype` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_cart')) {
...
if(pdo_tableexists('weisrc_dish_cart')) {
	if(!pdo_fieldexists('weisrc_dish_cart',  'packvalue')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_cart')." ADD `packvalue` varchar(10) NOT NULL DEFAULT '0' COMMENT '打包费';");
	}	
}
if(pdo_tableexists('weisrc_dish_cart')) {
	if(!pdo_fieldexists('weisrc_dish_cart',  'optionid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_cart')." ADD `optionid` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_cart')) {
	if(!pdo_fieldexists('weisrc_dish_cart',  'optionname')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_cart')." ADD `optionname` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_cashlog')) {
...
if(pdo_tableexists('weisrc_dish_cashlog')) {
	if(!pdo_fieldexists('weisrc_dish_cashlog',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_cashlog')." ADD `from_user` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_cashlog')) {
...
if(pdo_tableexists('weisrc_dish_category')) {
...
if(pdo_tableexists('weisrc_dish_category')) {
	if(!pdo_fieldexists('weisrc_dish_category',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_category')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '门店id';");
	}	
}
if(pdo_tableexists('weisrc_dish_category')) {
	if(!pdo_fieldexists('weisrc_dish_category',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_category')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_category')) {
	if(!pdo_fieldexists('weisrc_dish_category',  'name')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_category')." ADD `name` varchar(50) NOT NULL COMMENT '分类名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_category')) {
	if(!pdo_fieldexists('weisrc_dish_category',  'parentid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_category')." ADD `parentid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '上级分类ID,0为第一级';");
	}	
}
if(pdo_tableexists('weisrc_dish_category')) {
	if(!pdo_fieldexists('weisrc_dish_category',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_category')." ADD `displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
	}	
}
if(pdo_tableexists('weisrc_dish_category')) {
	if(!pdo_fieldexists('weisrc_dish_category',  'enabled')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_category')." ADD `enabled` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否开启';");
	}	
}
if(pdo_tableexists('weisrc_dish_category')) {
	if(!pdo_fieldexists('weisrc_dish_category',  'is_meal')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_category')." ADD `is_meal` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否店内点餐';");
	}	
}
if(pdo_tableexists('weisrc_dish_category')) {
	if(!pdo_fieldexists('weisrc_dish_category',  'is_delivery')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_category')." ADD `is_delivery` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否外卖订餐';");
	}	
}
if(pdo_tableexists('weisrc_dish_category')) {
	if(!pdo_fieldexists('weisrc_dish_category',  'is_snack')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_category')." ADD `is_snack` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否支持快餐';");
	}	
}
if(pdo_tableexists('weisrc_dish_category')) {
	if(!pdo_fieldexists('weisrc_dish_category',  'is_reservation')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_category')." ADD `is_reservation` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否支持预定';");
	}	
}
if(pdo_tableexists('weisrc_dish_category')) {
...
if(pdo_tableexists('weisrc_dish_collection')) {
...
if(pdo_tableexists('weisrc_dish_collection')) {
	if(!pdo_fieldexists('weisrc_dish_collection',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_collection')." ADD `dateline` int(10) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_commission')) {
...
if(pdo_tableexists('weisrc_dish_commission')) {
	if(!pdo_fieldexists('weisrc_dish_commission',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_commission')." ADD `weid` int(10) unsigned DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_commission')) {
	if(!pdo_fieldexists('weisrc_dish_commission',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_commission')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '门店编号';");
	}	
}
if(pdo_tableexists('weisrc_dish_commission')) {
	if(!pdo_fieldexists('weisrc_dish_commission',  'orderid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_commission')." ADD `orderid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '订单编号';");
	}	
}
if(pdo_tableexists('weisrc_dish_commission')) {
	if(!pdo_fieldexists('weisrc_dish_commission',  'agentid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_commission')." ADD `agentid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '上级编号';");
	}	
}
if(pdo_tableexists('weisrc_dish_commission')) {
	if(!pdo_fieldexists('weisrc_dish_commission',  'ordersn')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_commission')." ADD `ordersn` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_commission')) {
	if(!pdo_fieldexists('weisrc_dish_commission',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_commission')." ADD `from_user` varchar(100) COMMENT '购买者openid';");
	}	
}
if(pdo_tableexists('weisrc_dish_commission')) {
	if(!pdo_fieldexists('weisrc_dish_commission',  'price')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_commission')." ADD `price` decimal(10,2) DEFAULT '0.00';");
	}	
}
if(pdo_tableexists('weisrc_dish_commission')) {
	if(!pdo_fieldexists('weisrc_dish_commission',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_commission')." ADD `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_commission')) {
	if(!pdo_fieldexists('weisrc_dish_commission',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_commission')." ADD `dateline` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_commission')) {
	if(!pdo_fieldexists('weisrc_dish_commission',  'level')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_commission')." ADD `level` tinyint(1) NOT NULL DEFAULT '1' COMMENT '级别';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
...
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `weid` int(10) NOT NULL DEFAULT '0' COMMENT '公众号id';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `storeid` int(10) NOT NULL DEFAULT '0' COMMENT '门店id';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'levelid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `levelid` tinyint(1) NOT NULL DEFAULT '0' COMMENT '所属人群';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'title')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `title` varchar(50) NOT NULL COMMENT '优惠券名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'thumb')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `thumb` varchar(500) NOT NULL COMMENT '图片';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'attr_type')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `attr_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '属性 1=普通券 2=营销券';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'ruletype')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `ruletype` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1=不限 2=首单';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'type')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '优惠券类型 1=优惠券 2=代金券 3=礼品券 4=积分兑换';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'gmoney')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `gmoney` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '支付金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'dmoney')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `dmoney` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '抵用金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'content')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `content` text NOT NULL COMMENT '详细内容';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'totalcount')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `totalcount` int(10) NOT NULL DEFAULT '0' COMMENT '发放总数';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'usercount')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `usercount` int(10) NOT NULL DEFAULT '0' COMMENT '每人领取张数';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'ticket_ty')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `ticket_ty` tinyint(1) NOT NULL DEFAULT '0' COMMENT '积分兑换优惠券类型 1=优惠券2=代金券3=礼品券';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'ticket_id')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `ticket_id` int(10) NOT NULL DEFAULT '0' COMMENT '优惠券id';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'needscore')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `needscore` int(10) NOT NULL DEFAULT '0' COMMENT '兑换需要积分';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'starttime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `starttime` int(10) NOT NULL DEFAULT '0' COMMENT '开始时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'endtime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `endtime` int(10) NOT NULL DEFAULT '0' COMMENT '结束时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `displayorder` tinyint(4) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
	if(!pdo_fieldexists('weisrc_dish_coupon',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_coupon')." ADD `dateline` int(10) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_coupon')) {
...
if(pdo_tableexists('weisrc_dish_credits_record')) {
...
if(pdo_tableexists('weisrc_dish_credits_record')) {
	if(!pdo_fieldexists('weisrc_dish_credits_record',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_credits_record')." ADD `from_user` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_credits_record')) {
	if(!pdo_fieldexists('weisrc_dish_credits_record',  'credittype')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_credits_record')." ADD `credittype` varchar(100) COMMENT '积分类型';");
	}	
}
if(pdo_tableexists('weisrc_dish_credits_record')) {
...
if(pdo_tableexists('weisrc_dish_credits_record')) {
	if(!pdo_fieldexists('weisrc_dish_credits_record',  'operator')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_credits_record')." ADD `operator` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_credits_record')) {
	if(!pdo_fieldexists('weisrc_dish_credits_record',  'remark')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_credits_record')." ADD `remark` varchar(1000) COMMENT '内容';");
	}	
}
if(pdo_tableexists('weisrc_dish_credits_record')) {
...
if(pdo_tableexists('weisrc_dish_delivery_record')) {
...
if(pdo_tableexists('weisrc_dish_deliveryarea')) {
...
if(pdo_tableexists('weisrc_dish_deliverytime')) {
	if(!pdo_fieldexists('weisrc_dish_deliverytime',  'id')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_deliverytime')." ADD `id` int(10) NOT NULL AUTO_INCREMENT;");
	}	
}
if(pdo_tableexists('weisrc_dish_deliverytime')) {
	if(!pdo_fieldexists('weisrc_dish_deliverytime',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_deliverytime')." ADD `weid` int(10) unsigned NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_deliverytime')) {
	if(!pdo_fieldexists('weisrc_dish_deliverytime',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_deliverytime')." ADD `storeid` int(10) unsigned NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_deliverytime')) {
	if(!pdo_fieldexists('weisrc_dish_deliverytime',  'begintime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_deliverytime')." ADD `begintime` varchar(20) DEFAULT '09:00' COMMENT '开始时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_deliverytime')) {
	if(!pdo_fieldexists('weisrc_dish_deliverytime',  'endtime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_deliverytime')." ADD `endtime` varchar(20) DEFAULT '18:00' COMMENT '结束时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_deliverytime')) {
	if(!pdo_fieldexists('weisrc_dish_deliverytime',  'price')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_deliverytime')." ADD `price` decimal(10,2) DEFAULT '0.00';");
	}	
}
if(pdo_tableexists('weisrc_dish_deliverytime')) {
	if(!pdo_fieldexists('weisrc_dish_deliverytime',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_deliverytime')." ADD `dateline` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_dispatcharea')) {
...
if(pdo_tableexists('weisrc_dish_distance')) {
...
if(pdo_tableexists('weisrc_dish_email_setting')) {
...
if(pdo_tableexists('weisrc_dish_email_setting')) {
	if(!pdo_fieldexists('weisrc_dish_email_setting',  'email_enable')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_email_setting')." ADD `email_enable` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '开启邮箱提醒';");
	}	
}
if(pdo_tableexists('weisrc_dish_email_setting')) {
	if(!pdo_fieldexists('weisrc_dish_email_setting',  'email_host')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_email_setting')." ADD `email_host` varchar(50) COMMENT '邮箱服务器';");
	}	
}
if(pdo_tableexists('weisrc_dish_email_setting')) {
	if(!pdo_fieldexists('weisrc_dish_email_setting',  'email_send')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_email_setting')." ADD `email_send` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_email_setting')) {
	if(!pdo_fieldexists('weisrc_dish_email_setting',  'email_pwd')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_email_setting')." ADD `email_pwd` varchar(20) COMMENT '邮箱密码';");
	}	
}
if(pdo_tableexists('weisrc_dish_email_setting')) {
	if(!pdo_fieldexists('weisrc_dish_email_setting',  'email_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_email_setting')." ADD `email_user` varchar(100) COMMENT '发信人名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_email_setting')) {
	if(!pdo_fieldexists('weisrc_dish_email_setting',  'email')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_email_setting')." ADD `email` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_email_setting')) {
	if(!pdo_fieldexists('weisrc_dish_email_setting',  'email_business_tpl')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_email_setting')." ADD `email_business_tpl` varchar(200) COMMENT '商户接收内容模板';");
	}	
}
if(pdo_tableexists('weisrc_dish_email_setting')) {
	if(!pdo_fieldexists('weisrc_dish_email_setting',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_email_setting')." ADD `dateline` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
...
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `weid` int(11) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `from_user` varchar(50) COMMENT '用户ID';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'nickname')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `nickname` varchar(50);");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'headimgurl')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `headimgurl` varchar(500);");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'username')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `username` varchar(50);");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'mobile')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `mobile` varchar(50);");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'address')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `address` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'sex')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `sex` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '性别';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'lat')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `lat` decimal(18,10) NOT NULL DEFAULT '0.0000000000' COMMENT '经度';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'lng')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `lng` decimal(18,10) NOT NULL DEFAULT '0.0000000000' COMMENT '纬度';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `status` tinyint(1) DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `dateline` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `storeid` int(11) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'totalcount')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `totalcount` int(10) DEFAULT '0' COMMENT '交易次数';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'totalprice')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `totalprice` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '交易总金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'avgprice')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `avgprice` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '平均金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'uid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `uid` int(11) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'paytime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `paytime` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'lasttime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `lasttime` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'agentid2')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `agentid2` int(11) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'agentid3')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `agentid3` int(11) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'noticetime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `noticetime` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'agentid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `agentid` int(11) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'country')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `country` varchar(50);");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'province')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `province` varchar(50);");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'city')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `city` varchar(50);");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
...
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'scene_str')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `scene_str` varchar(500);");
	}	
}
if(pdo_tableexists('weisrc_dish_fans')) {
	if(!pdo_fieldexists('weisrc_dish_fans',  'storeids')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fans')." ADD `storeids` text COMMENT '门店';");
	}	
}
if(pdo_tableexists('weisrc_dish_feedback')) {
...
if(pdo_tableexists('weisrc_dish_feedback')) {
	if(!pdo_fieldexists('weisrc_dish_feedback',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_feedback')." ADD `weid` int(10) unsigned DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_feedback')) {
	if(!pdo_fieldexists('weisrc_dish_feedback',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_feedback')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '门店编号';");
	}	
}
if(pdo_tableexists('weisrc_dish_feedback')) {
	if(!pdo_fieldexists('weisrc_dish_feedback',  'orderid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_feedback')." ADD `orderid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '订单编号';");
	}	
}
if(pdo_tableexists('weisrc_dish_feedback')) {
	if(!pdo_fieldexists('weisrc_dish_feedback',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_feedback')." ADD `from_user` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_feedback')) {
	if(!pdo_fieldexists('weisrc_dish_feedback',  'star')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_feedback')." ADD `star` tinyint(1) NOT NULL DEFAULT '5' COMMENT '等级';");
	}	
}
if(pdo_tableexists('weisrc_dish_feedback')) {
	if(!pdo_fieldexists('weisrc_dish_feedback',  'content')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_feedback')." ADD `content` varchar(500) COMMENT '回复内容';");
	}	
}
if(pdo_tableexists('weisrc_dish_feedback')) {
	if(!pdo_fieldexists('weisrc_dish_feedback',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_feedback')." ADD `displayorder` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
	}	
}
if(pdo_tableexists('weisrc_dish_feedback')) {
	if(!pdo_fieldexists('weisrc_dish_feedback',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_feedback')." ADD `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_feedback')) {
	if(!pdo_fieldexists('weisrc_dish_feedback',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_feedback')." ADD `dateline` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_fengniao')) {
...
if(pdo_tableexists('weisrc_dish_fengniao')) {
	if(!pdo_fieldexists('weisrc_dish_fengniao',  'open_order_code')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fengniao')." ADD `open_order_code` varchar(200) COMMENT '蜂鸟配送开放平台返回的订单号';");
	}	
}
if(pdo_tableexists('weisrc_dish_fengniao')) {
	if(!pdo_fieldexists('weisrc_dish_fengniao',  'partner_order_code')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fengniao')." ADD `partner_order_code` varchar(200) COMMENT '商户自己的订单号';");
	}	
}
if(pdo_tableexists('weisrc_dish_fengniao')) {
...
if(pdo_tableexists('weisrc_dish_fengniao')) {
	if(!pdo_fieldexists('weisrc_dish_fengniao',  'carrier_driver_name')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fengniao')." ADD `carrier_driver_name` varchar(200) COMMENT '蜂鸟配送员姓名';");
	}	
}
if(pdo_tableexists('weisrc_dish_fengniao')) {
	if(!pdo_fieldexists('weisrc_dish_fengniao',  'carrier_driver_phone')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fengniao')." ADD `carrier_driver_phone` varchar(200) COMMENT '蜂鸟配送员电话';");
	}	
}
if(pdo_tableexists('weisrc_dish_fengniao')) {
	if(!pdo_fieldexists('weisrc_dish_fengniao',  'description')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fengniao')." ADD `description` varchar(200) COMMENT '描述信息';");
	}	
}
if(pdo_tableexists('weisrc_dish_fengniao')) {
	if(!pdo_fieldexists('weisrc_dish_fengniao',  'address')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fengniao')." ADD `address` varchar(200) COMMENT '定点次日达服务独有的字段: 微仓地址';");
	}	
}
if(pdo_tableexists('weisrc_dish_fengniao')) {
...
if(pdo_tableexists('weisrc_dish_fengniao')) {
	if(!pdo_fieldexists('weisrc_dish_fengniao',  'error_code')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_fengniao')." ADD `error_code` varchar(200) COMMENT '错误编码';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
...
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'pcate')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `pcate` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'ccate')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `ccate` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'recommend')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `recommend` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否推荐';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `displayorder` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
...
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'unitname')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `unitname` varchar(5) NOT NULL DEFAULT '份';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
...
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'taste')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `taste` varchar(1000) NOT NULL COMMENT '口味';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'isspecial')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `isspecial` tinyint(1) unsigned NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
...
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'credit')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `credit` int(10) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'subcount')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `subcount` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '被点次数';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
...
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'labelid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `labelid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '打印标签';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'memberprice')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `memberprice` varchar(10) NOT NULL COMMENT '会员价';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'lasttime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `lasttime` int(10) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'deleted')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `deleted` tinyint(1) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'counts')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `counts` int(10) NOT NULL DEFAULT '-1';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'sales')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `sales` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'today_counts')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `today_counts` int(10) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'packvalue')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `packvalue` varchar(10) NOT NULL DEFAULT '0' COMMENT '打包费';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
...
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'isshow_sales')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `isshow_sales` tinyint(1) unsigned NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'isoptions')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `isoptions` tinyint(1) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'istime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `istime` tinyint(1) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'begintime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `begintime` varchar(20) DEFAULT '00:00' COMMENT '开始时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'endtime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `endtime` varchar(20) DEFAULT '23:59' COMMENT '结束时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'startdate')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `startdate` int(10) NOT NULL DEFAULT '0' COMMENT '开始时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods')) {
	if(!pdo_fieldexists('weisrc_dish_goods',  'enddate')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods')." ADD `enddate` int(10) NOT NULL DEFAULT '0' COMMENT '结束时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_goods_option')) {
...
if(pdo_tableexists('weisrc_dish_goods_option')) {
	if(!pdo_fieldexists('weisrc_dish_goods_option',  'start')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods_option')." ADD `start` varchar(50);");
	}	
}
if(pdo_tableexists('weisrc_dish_goods_option')) {
	if(!pdo_fieldexists('weisrc_dish_goods_option',  'title')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_goods_option')." ADD `title` varchar(50);");
	}	
}
if(pdo_tableexists('weisrc_dish_goods_option')) {
...
if(pdo_tableexists('weisrc_dish_intelligent')) {
...
if(pdo_tableexists('weisrc_dish_intelligent')) {
	if(!pdo_fieldexists('weisrc_dish_intelligent',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_intelligent')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '门店id';");
	}	
}
if(pdo_tableexists('weisrc_dish_intelligent')) {
	if(!pdo_fieldexists('weisrc_dish_intelligent',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_intelligent')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_intelligent')) {
	if(!pdo_fieldexists('weisrc_dish_intelligent',  'name')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_intelligent')." ADD `name` int(10) NOT NULL DEFAULT '0' COMMENT '适用人数';");
	}	
}
if(pdo_tableexists('weisrc_dish_intelligent')) {
	if(!pdo_fieldexists('weisrc_dish_intelligent',  'content')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_intelligent')." ADD `content` varchar(1000) NOT NULL COMMENT '菜品';");
	}	
}
if(pdo_tableexists('weisrc_dish_intelligent')) {
	if(!pdo_fieldexists('weisrc_dish_intelligent',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_intelligent')." ADD `displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
	}	
}
if(pdo_tableexists('weisrc_dish_intelligent')) {
	if(!pdo_fieldexists('weisrc_dish_intelligent',  'enabled')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_intelligent')." ADD `enabled` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否开启';");
	}	
}
if(pdo_tableexists('weisrc_dish_mealtime')) {
...
if(pdo_tableexists('weisrc_dish_mealtime')) {
	if(!pdo_fieldexists('weisrc_dish_mealtime',  'begintime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_mealtime')." ADD `begintime` varchar(20) DEFAULT '09:00' COMMENT '开始时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_mealtime')) {
	if(!pdo_fieldexists('weisrc_dish_mealtime',  'endtime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_mealtime')." ADD `endtime` varchar(20) DEFAULT '18:00' COMMENT '结束时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_mealtime')) {
...
if(pdo_tableexists('weisrc_dish_nave')) {
...
if(pdo_tableexists('weisrc_dish_nave')) {
	if(!pdo_fieldexists('weisrc_dish_nave',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_nave')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_nave')) {
	if(!pdo_fieldexists('weisrc_dish_nave',  'type')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_nave')." ADD `type` int(10) NOT NULL DEFAULT '-1' COMMENT '链接类型 -1:自定义 1:首页2:门店3:菜单列表4:我的菜单';");
	}	
}
if(pdo_tableexists('weisrc_dish_nave')) {
	if(!pdo_fieldexists('weisrc_dish_nave',  'name')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_nave')." ADD `name` varchar(50) NOT NULL COMMENT '导航名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_nave')) {
	if(!pdo_fieldexists('weisrc_dish_nave',  'link')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_nave')." ADD `link` varchar(200) NOT NULL COMMENT '导航链接';");
	}	
}
if(pdo_tableexists('weisrc_dish_nave')) {
	if(!pdo_fieldexists('weisrc_dish_nave',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_nave')." ADD `displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
	}	
}
if(pdo_tableexists('weisrc_dish_nave')) {
	if(!pdo_fieldexists('weisrc_dish_nave',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_nave')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否开启';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
...
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `weid` int(10) unsigned NOT NULL COMMENT '公众号id';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `storeid` int(10) unsigned NOT NULL COMMENT '门店id';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
...
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'ordersn')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `ordersn` varchar(30) NOT NULL COMMENT '订单号';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'totalnum')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `totalnum` tinyint(4) COMMENT '总数量';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'totalprice')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `totalprice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '总价格';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '-1取消状态，0普通状态，1为确认付款方式，2为成功';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'paytype')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `paytype` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '1余额，2在线，3到付';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'username')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `username` varchar(50) NOT NULL COMMENT '用户名';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'address')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `address` varchar(250) NOT NULL COMMENT '地址';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'tel')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `tel` varchar(50) NOT NULL COMMENT '联系电话';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'reply')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `reply` varchar(1000) NOT NULL COMMENT '回复';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'meal_time')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `meal_time` varchar(50) NOT NULL COMMENT '就餐时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'counts')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `counts` tinyint(4) DEFAULT '0' COMMENT '预订人数';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'seat_type')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `seat_type` tinyint(1) DEFAULT '0' COMMENT '位置类型1大厅2包间';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'carports')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `carports` tinyint(3) DEFAULT '0' COMMENT '车位';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
...
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'remark')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `remark` varchar(1000) NOT NULL COMMENT '备注';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'tables')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `tables` varchar(10) NOT NULL COMMENT '桌号';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
...
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'isfinish')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `isfinish` tinyint(1) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
...
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'packvalue')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `packvalue` varchar(10) NOT NULL DEFAULT '0' COMMENT '打包费';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
...
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'isfeedback')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `isfeedback` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否留言';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'couponid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `couponid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
...
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'paydetail')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `paydetail` varchar(1000) NOT NULL COMMENT '消费详细信息';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
...
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'tablezonesid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `tablezonesid` varchar(10) NOT NULL COMMENT '桌台类别';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
...
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'newlimitprice')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `newlimitprice` varchar(500) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'oldlimitprice')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `oldlimitprice` varchar(500) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'newlimitpricevalue')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `newlimitpricevalue` varchar(10) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'oldlimitpricevalue')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `oldlimitpricevalue` varchar(10) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'isprint')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `isprint` tinyint(1) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_order')) {
	if(!pdo_fieldexists('weisrc_dish_order',  'ischeckfans')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order')." ADD `ischeckfans` tinyint(1) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_order_goods')) {
...
if(pdo_tableexists('weisrc_dish_order_goods')) {
	if(!pdo_fieldexists('weisrc_dish_order_goods',  'price')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order_goods')." ADD `price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '商品价格';");
	}	
}
if(pdo_tableexists('weisrc_dish_order_goods')) {
	if(!pdo_fieldexists('weisrc_dish_order_goods',  'total')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order_goods')." ADD `total` int(10) unsigned NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_order_goods')) {
...
if(pdo_tableexists('weisrc_dish_order_goods')) {
	if(!pdo_fieldexists('weisrc_dish_order_goods',  'optionid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order_goods')." ADD `optionid` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_order_goods')) {
	if(!pdo_fieldexists('weisrc_dish_order_goods',  'optionname')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order_goods')." ADD `optionname` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_order_log')) {
...
if(pdo_tableexists('weisrc_dish_order_log')) {
	if(!pdo_fieldexists('weisrc_dish_order_log',  'content')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_order_log')." ADD `content` varchar(1000) COMMENT '内容';");
	}	
}
if(pdo_tableexists('weisrc_dish_order_log')) {
...
if(pdo_tableexists('weisrc_dish_print_label')) {
...
if(pdo_tableexists('weisrc_dish_print_label')) {
	if(!pdo_fieldexists('weisrc_dish_print_label',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_label')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '门店id';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_label')) {
	if(!pdo_fieldexists('weisrc_dish_print_label',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_label')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_label')) {
	if(!pdo_fieldexists('weisrc_dish_print_label',  'title')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_label')." ADD `title` varchar(50) NOT NULL COMMENT '标签名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_label')) {
	if(!pdo_fieldexists('weisrc_dish_print_label',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_label')." ADD `displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_label')) {
	if(!pdo_fieldexists('weisrc_dish_print_label',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_label')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否开启';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_order')) {
...
if(pdo_tableexists('weisrc_dish_print_order')) {
	if(!pdo_fieldexists('weisrc_dish_print_order',  'print_usr')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_order')." ADD `print_usr` varchar(50);");
	}	
}
if(pdo_tableexists('weisrc_dish_print_order')) {
	if(!pdo_fieldexists('weisrc_dish_print_order',  'print_status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_order')." ADD `print_status` tinyint(1) DEFAULT '-1';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_order')) {
	if(!pdo_fieldexists('weisrc_dish_print_order',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_order')." ADD `dateline` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
...
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'title')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `title` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
...
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'print_usr')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `print_usr` varchar(50);");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'print_nums')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `print_nums` tinyint(3) DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'print_top')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `print_top` varchar(40);");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'print_bottom')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `print_bottom` varchar(40);");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `dateline` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
...
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'qrcode_url')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `qrcode_url` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
...
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'member_code')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `member_code` varchar(100) COMMENT '商户代码';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'feyin_key')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `feyin_key` varchar(100) COMMENT 'api密钥';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'yilian_type')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `yilian_type` tinyint(1) DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
...
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'api_key')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `api_key` varchar(100) COMMENT 'api密钥';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
...
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'print_label')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `print_label` varchar(500) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'is_meal')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `is_meal` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否店内点餐';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'is_delivery')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `is_delivery` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否外卖订餐';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'is_snack')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `is_snack` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否支持快餐';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'is_reservation')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `is_reservation` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否支持预定';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
...
if(pdo_tableexists('weisrc_dish_print_setting')) {
	if(!pdo_fieldexists('weisrc_dish_print_setting',  'printid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_print_setting')." ADD `printid` int(5) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_print_setting')) {
...
if(pdo_tableexists('weisrc_dish_queue_order')) {
...
if(pdo_tableexists('weisrc_dish_queue_order')) {
	if(!pdo_fieldexists('weisrc_dish_queue_order',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_order')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_order')) {
	if(!pdo_fieldexists('weisrc_dish_queue_order',  'queueid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_order')." ADD `queueid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_order')) {
	if(!pdo_fieldexists('weisrc_dish_queue_order',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_order')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_order')) {
...
if(pdo_tableexists('weisrc_dish_queue_order')) {
	if(!pdo_fieldexists('weisrc_dish_queue_order',  'usercount')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_order')." ADD `usercount` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_order')) {
	if(!pdo_fieldexists('weisrc_dish_queue_order',  'isnotify')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_order')." ADD `isnotify` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_order')) {
	if(!pdo_fieldexists('weisrc_dish_queue_order',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_order')." ADD `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_order')) {
	if(!pdo_fieldexists('weisrc_dish_queue_order',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_order')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_setting')) {
...
if(pdo_tableexists('weisrc_dish_queue_setting')) {
	if(!pdo_fieldexists('weisrc_dish_queue_setting',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_setting')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_setting')) {
	if(!pdo_fieldexists('weisrc_dish_queue_setting',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_setting')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_setting')) {
...
if(pdo_tableexists('weisrc_dish_queue_setting')) {
	if(!pdo_fieldexists('weisrc_dish_queue_setting',  'limit_num')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_setting')." ADD `limit_num` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_setting')) {
...
if(pdo_tableexists('weisrc_dish_queue_setting')) {
	if(!pdo_fieldexists('weisrc_dish_queue_setting',  'starttime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_setting')." ADD `starttime` varchar(50) NOT NULL DEFAULT '00:00' COMMENT '开始时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_setting')) {
	if(!pdo_fieldexists('weisrc_dish_queue_setting',  'endtime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_setting')." ADD `endtime` varchar(50) NOT NULL DEFAULT '23:59' COMMENT '结束时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_setting')) {
	if(!pdo_fieldexists('weisrc_dish_queue_setting',  'notify_number')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_setting')." ADD `notify_number` int(10) NOT NULL DEFAULT '0' COMMENT '通知人数';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_setting')) {
	if(!pdo_fieldexists('weisrc_dish_queue_setting',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_setting')." ADD `displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_setting')) {
	if(!pdo_fieldexists('weisrc_dish_queue_setting',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_setting')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_queue_setting')) {
	if(!pdo_fieldexists('weisrc_dish_queue_setting',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_queue_setting')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_recharge')) {
...
if(pdo_tableexists('weisrc_dish_recharge_record')) {
...
if(pdo_tableexists('weisrc_dish_recharge_record')) {
	if(!pdo_fieldexists('weisrc_dish_recharge_record',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_recharge_record')." ADD `from_user` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_recharge_record')) {
...
if(pdo_tableexists('weisrc_dish_reply')) {
...
if(pdo_tableexists('weisrc_dish_reply')) {
	if(!pdo_fieldexists('weisrc_dish_reply',  'type')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_reply')." ADD `type` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '入口类型';");
	}	
}
if(pdo_tableexists('weisrc_dish_reply')) {
	if(!pdo_fieldexists('weisrc_dish_reply',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_reply')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '入口门店';");
	}	
}
if(pdo_tableexists('weisrc_dish_reply')) {
...
if(pdo_tableexists('weisrc_dish_reply')) {
	if(!pdo_fieldexists('weisrc_dish_reply',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_reply')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '添加日期';");
	}	
}
if(pdo_tableexists('weisrc_dish_reservation')) {
...
if(pdo_tableexists('weisrc_dish_reservation')) {
	if(!pdo_fieldexists('weisrc_dish_reservation',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_reservation')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_reservation')) {
	if(!pdo_fieldexists('weisrc_dish_reservation',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_reservation')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_reservation')) {
	if(!pdo_fieldexists('weisrc_dish_reservation',  'tablezonesid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_reservation')." ADD `tablezonesid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_reservation')) {
...
if(pdo_tableexists('weisrc_dish_reservation')) {
	if(!pdo_fieldexists('weisrc_dish_reservation',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_reservation')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_reservation')) {
	if(!pdo_fieldexists('weisrc_dish_reservation',  'label')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_reservation')." ADD `label` varchar(50) NOT NULL COMMENT '标签';");
	}	
}
if(pdo_tableexists('weisrc_dish_reservation')) {
	if(!pdo_fieldexists('weisrc_dish_reservation',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_reservation')." ADD `displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
	}	
}
if(pdo_tableexists('weisrc_dish_savewine_log')) {
...
if(pdo_tableexists('weisrc_dish_savewine_log')) {
	if(!pdo_fieldexists('weisrc_dish_savewine_log',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '门店编号';");
	}	
}
if(pdo_tableexists('weisrc_dish_savewine_log')) {
	if(!pdo_fieldexists('weisrc_dish_savewine_log',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `from_user` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_savewine_log')) {
	if(!pdo_fieldexists('weisrc_dish_savewine_log',  'savenumber')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `savenumber` varchar(100) NOT NULL COMMENT '存酒卡号';");
	}	
}
if(pdo_tableexists('weisrc_dish_savewine_log')) {
	if(!pdo_fieldexists('weisrc_dish_savewine_log',  'title')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `title` varchar(200) COMMENT '物品名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_savewine_log')) {
	if(!pdo_fieldexists('weisrc_dish_savewine_log',  'username')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `username` varchar(100) COMMENT '用户姓名';");
	}	
}
if(pdo_tableexists('weisrc_dish_savewine_log')) {
	if(!pdo_fieldexists('weisrc_dish_savewine_log',  'tel')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `tel` varchar(30) COMMENT '联系电话';");
	}	
}
if(pdo_tableexists('weisrc_dish_savewine_log')) {
	if(!pdo_fieldexists('weisrc_dish_savewine_log',  'remark')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `remark` text NOT NULL COMMENT '备注';");
	}	
}
if(pdo_tableexists('weisrc_dish_savewine_log')) {
	if(!pdo_fieldexists('weisrc_dish_savewine_log',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `displayorder` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_savewine_log')) {
	if(!pdo_fieldexists('weisrc_dish_savewine_log',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_savewine_log')) {
	if(!pdo_fieldexists('weisrc_dish_savewine_log',  'takeouttime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `takeouttime` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_savewine_log')) {
	if(!pdo_fieldexists('weisrc_dish_savewine_log',  'savetime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `savetime` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_savewine_log')) {
	if(!pdo_fieldexists('weisrc_dish_savewine_log',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_savewine_log')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_service_log')) {
...
if(pdo_tableexists('weisrc_dish_service_log')) {
	if(!pdo_fieldexists('weisrc_dish_service_log',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_service_log')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '门店编号';");
	}	
}
if(pdo_tableexists('weisrc_dish_service_log')) {
	if(!pdo_fieldexists('weisrc_dish_service_log',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_service_log')." ADD `from_user` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_service_log')) {
	if(!pdo_fieldexists('weisrc_dish_service_log',  'content')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_service_log')." ADD `content` varchar(1000) COMMENT '内容';");
	}	
}
if(pdo_tableexists('weisrc_dish_service_log')) {
	if(!pdo_fieldexists('weisrc_dish_service_log',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_service_log')." ADD `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_service_log')) {
	if(!pdo_fieldexists('weisrc_dish_service_log',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_service_log')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'title')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `title` varchar(50) COMMENT '网站名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'thumb')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `thumb` varchar(200) COMMENT '背景图';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'entrance_type')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `entrance_type` tinyint(1) unsigned NOT NULL COMMENT '入口类型1:首页2门店列表3菜品列表4我的菜单';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'entrance_storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `entrance_storeid` tinyint(1) unsigned NOT NULL COMMENT '入口门店id';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'order_enable')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `order_enable` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '订餐开启';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `dateline` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'tplneworder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `tplneworder` varchar(200) COMMENT '模板id';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'searchword')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `searchword` varchar(1000) COMMENT '搜索关键字';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'tplboss')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `tplboss` varchar(200) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'wechat')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `wechat` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'alipay')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `alipay` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'credit')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `credit` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'delivery')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `delivery` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'is_speaker')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `is_speaker` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'tploperator')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `tploperator` varchar(200) COMMENT '模板id';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'link_card')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `link_card` varchar(500);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'link_sign')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `link_sign` varchar(500);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'link_sign_name')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `link_sign_name` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'link_card_name')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `link_card_name` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'commission_level')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `commission_level` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '分销级别';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'share_title')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `share_title` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'share_desc')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `share_desc` varchar(300);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'share_image')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `share_image` varchar(500);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'commission2_rate_max')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `commission2_rate_max` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '佣金费率';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'commission2_value_max')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `commission2_value_max` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '提现手续费最低金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'commission3_rate_max')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `commission3_rate_max` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '佣金费率';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'commission3_value_max')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `commission3_value_max` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '提现手续费最低金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'is_commission')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `is_commission` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '开启分销';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'commission1_rate_max')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `commission1_rate_max` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '佣金费率';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'commission1_value_max')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `commission1_value_max` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '提现手续费最低金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'commission_settlement')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `commission_settlement` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '佣金结算方式';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'getcash_price')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `getcash_price` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '最低提现金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'fee_rate')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `fee_rate` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '提现费率';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'fee_min')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `fee_min` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '提现手续费最低金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'fee_max')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `fee_max` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '提现手续费最高金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'operator_pwd')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `operator_pwd` varchar(50);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'follow_url')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `follow_url` varchar(500);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'isneedfollow')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `isneedfollow` tinyint(1) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'tplnewqueue')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `tplnewqueue` varchar(200) COMMENT '模板id';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'sms_username')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `sms_username` varchar(20) COMMENT '平台帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'sms_pwd')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `sms_pwd` varchar(20) COMMENT '平台密码';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'sms_mobile')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `sms_mobile` varchar(20) COMMENT '商户接收短信手机';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'email_host')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `email_host` varchar(50) COMMENT '邮箱服务器';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'email_send')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `email_send` varchar(100) COMMENT '商户发送邮件邮箱';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'email_pwd')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `email_pwd` varchar(20) COMMENT '邮箱密码';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'email_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `email_user` varchar(100) COMMENT '发信人名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'email')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `email` varchar(100) COMMENT '商户接收邮件邮箱';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'tplapplynotice')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `tplapplynotice` varchar(200) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'link_recharge')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `link_recharge` varchar(500);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'link_recharge_name')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `link_recharge_name` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'follow_title')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `follow_title` varchar(500);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'follow_desc')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `follow_desc` varchar(500);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'follow_logo')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `follow_logo` varchar(500);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'site_logo')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `site_logo` varchar(500);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'tipqrcode')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `tipqrcode` varchar(500);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
...
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'fengniao_appid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `fengniao_appid` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'fengniao_key')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `fengniao_key` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'is_verify_mobile')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `is_verify_mobile` tinyint(1) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'dayu_appkey')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `dayu_appkey` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'dayu_secretkey')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `dayu_secretkey` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'dayu_verify_code')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `dayu_verify_code` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'dayu_sign')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `dayu_sign` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'fengniao_mode')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `fengniao_mode` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1:正式启用;2:调试阶段';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'commission_keywords')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `commission_keywords` varchar(200);");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'credit_mode')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `credit_mode` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1:商品积分;2订单金额计算';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'payx_credit')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `payx_credit` int(10) NOT NULL DEFAULT '0' COMMENT '消费一元积分';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'is_auto_commission')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `is_auto_commission` tinyint(1) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'auto_commission_coin')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `auto_commission_coin` int(10) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'tplmission')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `tplmission` varchar(200) COMMENT '模板id';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'style_base')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `style_base` varchar(20) NOT NULL DEFAULT '#3190e8';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'style_list_btn1')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `style_list_btn1` varchar(20) NOT NULL DEFAULT '#6a3f34';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'style_list_btn2')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `style_list_btn2` varchar(20) NOT NULL DEFAULT '#a57664';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'style_list_btn3')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `style_list_btn3` varchar(20) NOT NULL DEFAULT '#9995a3';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'style_list_base')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `style_list_base` varchar(20) NOT NULL DEFAULT '#FE4F4E';");
	}	
}
if(pdo_tableexists('weisrc_dish_setting')) {
	if(!pdo_fieldexists('weisrc_dish_setting',  'is_open_price')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_setting')." ADD `is_open_price` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '开启提现';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_checkcode')) {
...
if(pdo_tableexists('weisrc_dish_sms_checkcode')) {
	if(!pdo_fieldexists('weisrc_dish_sms_checkcode',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_checkcode')." ADD `from_user` varchar(100) COMMENT '用户ID';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_checkcode')) {
	if(!pdo_fieldexists('weisrc_dish_sms_checkcode',  'mobile')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_checkcode')." ADD `mobile` varchar(30) COMMENT '手机';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_checkcode')) {
	if(!pdo_fieldexists('weisrc_dish_sms_checkcode',  'checkcode')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_checkcode')." ADD `checkcode` varchar(100) COMMENT '验证码';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_checkcode')) {
	if(!pdo_fieldexists('weisrc_dish_sms_checkcode',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_checkcode')." ADD `status` tinyint(1) unsigned DEFAULT '0' COMMENT '状态 0未使用1已使用';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_checkcode')) {
	if(!pdo_fieldexists('weisrc_dish_sms_checkcode',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_checkcode')." ADD `dateline` int(10) DEFAULT '0' COMMENT '创建时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_setting')) {
...
if(pdo_tableexists('weisrc_dish_sms_setting')) {
	if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_enable')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_enable` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '开启短信提醒';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_setting')) {
	if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_verify_enable')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_verify_enable` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '开启短信验证提醒';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_setting')) {
	if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_username')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_username` varchar(20) COMMENT '平台帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_setting')) {
	if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_pwd')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_pwd` varchar(20) COMMENT '平台密码';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_setting')) {
	if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_mobile')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_mobile` varchar(20) COMMENT '商户接收短信手机';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_setting')) {
	if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_verify_tpl')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_verify_tpl` varchar(120) COMMENT '验证短信模板';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_setting')) {
	if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_business_tpl')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_business_tpl` varchar(120) COMMENT '商户短信模板';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_setting')) {
	if(!pdo_fieldexists('weisrc_dish_sms_setting',  'sms_user_tpl')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `sms_user_tpl` varchar(120) COMMENT '用户短信模板';");
	}	
}
if(pdo_tableexists('weisrc_dish_sms_setting')) {
	if(!pdo_fieldexists('weisrc_dish_sms_setting',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sms_setting')." ADD `dateline` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_sncode')) {
...
if(pdo_tableexists('weisrc_dish_sncode')) {
	if(!pdo_fieldexists('weisrc_dish_sncode',  'couponid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sncode')." ADD `couponid` int(10) NOT NULL DEFAULT '0' COMMENT '优惠券id';");
	}	
}
if(pdo_tableexists('weisrc_dish_sncode')) {
	if(!pdo_fieldexists('weisrc_dish_sncode',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sncode')." ADD `storeid` int(10) NOT NULL DEFAULT '0' COMMENT '门店id';");
	}	
}
if(pdo_tableexists('weisrc_dish_sncode')) {
	if(!pdo_fieldexists('weisrc_dish_sncode',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sncode')." ADD `weid` int(10) NOT NULL DEFAULT '0' COMMENT '公众号id';");
	}	
}
if(pdo_tableexists('weisrc_dish_sncode')) {
	if(!pdo_fieldexists('weisrc_dish_sncode',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sncode')." ADD `from_user` varchar(100) NOT NULL COMMENT 'openid';");
	}	
}
if(pdo_tableexists('weisrc_dish_sncode')) {
...
if(pdo_tableexists('weisrc_dish_sncode')) {
	if(!pdo_fieldexists('weisrc_dish_sncode',  'sncode')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sncode')." ADD `sncode` varchar(100) NOT NULL COMMENT 'sn码';");
	}	
}
if(pdo_tableexists('weisrc_dish_sncode')) {
	if(!pdo_fieldexists('weisrc_dish_sncode',  'type')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sncode')." ADD `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1优惠券2代金券3礼品券';");
	}	
}
if(pdo_tableexists('weisrc_dish_sncode')) {
	if(!pdo_fieldexists('weisrc_dish_sncode',  'money')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sncode')." ADD `money` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '消费金额';");
	}	
}
if(pdo_tableexists('weisrc_dish_sncode')) {
	if(!pdo_fieldexists('weisrc_dish_sncode',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sncode')." ADD `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_sncode')) {
	if(!pdo_fieldexists('weisrc_dish_sncode',  'isshow')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sncode')." ADD `isshow` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否显示 用户删除时更新';");
	}	
}
if(pdo_tableexists('weisrc_dish_sncode')) {
	if(!pdo_fieldexists('weisrc_dish_sncode',  'winningtime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sncode')." ADD `winningtime` int(10) NOT NULL DEFAULT '0' COMMENT '生成时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_sncode')) {
	if(!pdo_fieldexists('weisrc_dish_sncode',  'usetime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sncode')." ADD `usetime` int(10) NOT NULL DEFAULT '0' COMMENT '使用时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_sncode')) {
	if(!pdo_fieldexists('weisrc_dish_sncode',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_sncode')." ADD `dateline` int(10) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_store_setting')) {
...
if(pdo_tableexists('weisrc_dish_store_setting')) {
	if(!pdo_fieldexists('weisrc_dish_store_setting',  'order_enable')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_store_setting')." ADD `order_enable` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '订餐开启';");
	}	
}
if(pdo_tableexists('weisrc_dish_store_setting')) {
	if(!pdo_fieldexists('weisrc_dish_store_setting',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_store_setting')." ADD `dateline` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `weid` int(10) NOT NULL DEFAULT '0' COMMENT '公众号id';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'title')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `title` varchar(50) NOT NULL COMMENT '名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'logo')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `logo` varchar(500) NOT NULL COMMENT '商家logo';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'info')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `info` varchar(1000) NOT NULL COMMENT '简短描述';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'content')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `content` text NOT NULL COMMENT '简介';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'tel')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `tel` varchar(20) NOT NULL COMMENT '联系电话';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'location_p')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `location_p` varchar(100) NOT NULL COMMENT '省';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'location_c')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `location_c` varchar(100) NOT NULL COMMENT '市';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'location_a')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `location_a` varchar(100) NOT NULL COMMENT '区';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'address')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `address` varchar(200) NOT NULL COMMENT '地址';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'lat')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `lat` decimal(18,10) NOT NULL DEFAULT '0.0000000000' COMMENT '经度';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'lng')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `lng` decimal(18,10) NOT NULL DEFAULT '0.0000000000' COMMENT '纬度';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'password')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `password` varchar(20) NOT NULL COMMENT '登录密码';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'hours')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `hours` varchar(200) NOT NULL COMMENT '营业时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'recharging_password')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `recharging_password` varchar(20) NOT NULL COMMENT '充值密码';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'thumb_url')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `thumb_url` varchar(1000);");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'enable_wifi')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `enable_wifi` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否有wifi';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'enable_card')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `enable_card` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否能刷卡';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'enable_room')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `enable_room` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否有包厢';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'enable_park')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `enable_park` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否有停车';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'is_show')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_show` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否在手机端显示';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'sendingprice')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `sendingprice` varchar(10) NOT NULL COMMENT '起送价格';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `displayorder` tinyint(3) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'updatetime')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `updatetime` int(10) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'is_sms')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_sms` tinyint(1) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `dateline` int(10) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'announce')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `announce` varchar(1000) NOT NULL COMMENT '通知';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'default_jump')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `default_jump` tinyint(2) NOT NULL DEFAULT '1' COMMENT '默认类型';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'default_jump_url')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `default_jump_url` varchar(500) NOT NULL COMMENT '默认链接';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'reservation_announce')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `reservation_announce` varchar(1000) NOT NULL COMMENT '预定公告';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'is_business')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_business` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否支持子商户支付';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'business_id')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `business_id` int(10) NOT NULL DEFAULT '0' COMMENT '子商户活动ID';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'wechat')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `wechat` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'alipay')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `alipay` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'credit')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `credit` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'delivery')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `delivery` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'delivery_isnot_today')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `delivery_isnot_today` tinyint(1) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'is_speaker')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_speaker` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'tea_tip')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `tea_tip` varchar(200) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'is_savewine')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_savewine` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否支持寄存';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'notice_space_time')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `notice_space_time` int(10) DEFAULT '300';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'is_operator1')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_operator1` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否支持呼叫服务员';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'is_operator2')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_operator2` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否支持打包';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'screen_mode')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `screen_mode` tinyint(1) NOT NULL DEFAULT '1';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'begintime1')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `begintime1` varchar(20) DEFAULT '09:00' COMMENT '开始时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'endtime1')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `endtime1` varchar(20) DEFAULT '18:00' COMMENT '结束时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'begintime2')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `begintime2` varchar(20) DEFAULT '09:00' COMMENT '开始时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'endtime2')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `endtime2` varchar(20) DEFAULT '18:00' COMMENT '结束时间';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'coupon_title1')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `coupon_title1` varchar(100) NOT NULL COMMENT '优惠名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'coupon_title2')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `coupon_title2` varchar(100) NOT NULL COMMENT '优惠名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'coupon_title3')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `coupon_title3` varchar(100) NOT NULL COMMENT '优惠名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'coupon_link1')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `coupon_link1` varchar(200) NOT NULL COMMENT '优惠名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'coupon_link2')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `coupon_link2` varchar(200) NOT NULL COMMENT '优惠名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'coupon_link3')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `coupon_link3` varchar(200) NOT NULL COMMENT '优惠名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'business_openid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `business_openid` varchar(200) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'business_username')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `business_username` varchar(200) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'business_alipay')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `business_alipay` varchar(200) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'business_wechat')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `business_wechat` varchar(200) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'is_ld_wxserver')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_ld_wxserver` tinyint(1);");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'ld_wxserver_url')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `ld_wxserver_url` varchar(255);");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'jueqi_host')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `jueqi_host` varchar(200) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'jueqi_customerId')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `jueqi_customerId` varchar(200) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'vtiny_bankpay_url')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `vtiny_bankpay_url` varchar(500) NOT NULL COMMENT '链接';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
...
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'business_mobile')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `business_mobile` varchar(30) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'jueqi_secret')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `jueqi_secret` varchar(200) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'is_jxkj_unipay')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_jxkj_unipay` int(1) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'jxkj_pay_id')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `jxkj_pay_id` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'jxkj_pay_name')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `jxkj_pay_name` varchar(50) NOT NULL DEFAULT '万融收银';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'remarkinfo')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `remarkinfo` varchar(1000) DEFAULT '可输入口味偏好要求(选填)';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'is_default_givecredit')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_default_givecredit` tinyint(1) NOT NULL DEFAULT '1' COMMENT '默认1,自定义2';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'givecredit')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `givecredit` int(10) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'is_delivery_time')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `is_delivery_time` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否特殊时间价格';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'listinfo')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `listinfo` varchar(1000) NOT NULL DEFAULT '用餐高峰期请提前下单！';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'btn_coupon_type')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `btn_coupon_type` tinyint(1) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'btn_coupon_url')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `btn_coupon_url` varchar(500) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'btn_coupon_id')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `btn_coupon_id` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'btn_coupon_price')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `btn_coupon_price` varchar(50) NOT NULL DEFAULT '15元';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'btn_coupon_title')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `btn_coupon_title` varchar(50) NOT NULL DEFAULT '商家优惠券';");
	}	
}
if(pdo_tableexists('weisrc_dish_stores')) {
	if(!pdo_fieldexists('weisrc_dish_stores',  'btn_coupon_desc')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_stores')." ADD `btn_coupon_desc` varchar(50) NOT NULL DEFAULT '消费满100元可用';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables')) {
...
if(pdo_tableexists('weisrc_dish_tables')) {
	if(!pdo_fieldexists('weisrc_dish_tables',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables')) {
	if(!pdo_fieldexists('weisrc_dish_tables',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables')) {
	if(!pdo_fieldexists('weisrc_dish_tables',  'tablezonesid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables')." ADD `tablezonesid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables')) {
	if(!pdo_fieldexists('weisrc_dish_tables',  'title')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables')." ADD `title` varchar(200) NOT NULL COMMENT '名字(桌台号)';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables')) {
	if(!pdo_fieldexists('weisrc_dish_tables',  'user_count')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables')." ADD `user_count` int(10) NOT NULL DEFAULT '0' COMMENT '可供就餐人数';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables')) {
	if(!pdo_fieldexists('weisrc_dish_tables',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables')." ADD `displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables')) {
	if(!pdo_fieldexists('weisrc_dish_tables',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables')) {
	if(!pdo_fieldexists('weisrc_dish_tables',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables')) {
...
if(pdo_tableexists('weisrc_dish_tables')) {
	if(!pdo_fieldexists('weisrc_dish_tables',  'thumb')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables')." ADD `thumb` varchar(500) NOT NULL COMMENT '图片';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables_order')) {
...
if(pdo_tableexists('weisrc_dish_tables_order')) {
	if(!pdo_fieldexists('weisrc_dish_tables_order',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables_order')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables_order')) {
	if(!pdo_fieldexists('weisrc_dish_tables_order',  'tablesid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables_order')." ADD `tablesid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables_order')) {
	if(!pdo_fieldexists('weisrc_dish_tables_order',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables_order')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_tables_order')) {
...
if(pdo_tableexists('weisrc_dish_tables_order')) {
	if(!pdo_fieldexists('weisrc_dish_tables_order',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tables_order')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_tablezones')) {
...
if(pdo_tableexists('weisrc_dish_tablezones')) {
	if(!pdo_fieldexists('weisrc_dish_tablezones',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tablezones')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_tablezones')) {
	if(!pdo_fieldexists('weisrc_dish_tablezones',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tablezones')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_tablezones')) {
...
if(pdo_tableexists('weisrc_dish_tablezones')) {
	if(!pdo_fieldexists('weisrc_dish_tablezones',  'limit_price')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tablezones')." ADD `limit_price` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_tablezones')) {
	if(!pdo_fieldexists('weisrc_dish_tablezones',  'reservation_price')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tablezones')." ADD `reservation_price` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_tablezones')) {
	if(!pdo_fieldexists('weisrc_dish_tablezones',  'table_count')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tablezones')." ADD `table_count` int(10) NOT NULL DEFAULT '0' COMMENT '餐桌数量';");
	}	
}
if(pdo_tableexists('weisrc_dish_tablezones')) {
	if(!pdo_fieldexists('weisrc_dish_tablezones',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tablezones')." ADD `displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
	}	
}
if(pdo_tableexists('weisrc_dish_tablezones')) {
	if(!pdo_fieldexists('weisrc_dish_tablezones',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tablezones')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_tablezones')) {
	if(!pdo_fieldexists('weisrc_dish_tablezones',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tablezones')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_tablezones')) {
...
if(pdo_tableexists('weisrc_dish_template')) {
...
if(pdo_tableexists('weisrc_dish_template')) {
	if(!pdo_fieldexists('weisrc_dish_template',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_template')." ADD `weid` int(10) NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_template')) {
	if(!pdo_fieldexists('weisrc_dish_template',  'template_name')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_template')." ADD `template_name` varchar(50) NOT NULL DEFAULT 'style1';");
	}	
}
if(pdo_tableexists('weisrc_dish_tpl_log')) {
...
if(pdo_tableexists('weisrc_dish_tpl_log')) {
	if(!pdo_fieldexists('weisrc_dish_tpl_log',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tpl_log')." ADD `weid` int(10) unsigned DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_tpl_log')) {
	if(!pdo_fieldexists('weisrc_dish_tpl_log',  'storeid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tpl_log')." ADD `storeid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '门店编号';");
	}	
}
if(pdo_tableexists('weisrc_dish_tpl_log')) {
	if(!pdo_fieldexists('weisrc_dish_tpl_log',  'orderid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tpl_log')." ADD `orderid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '订单编号';");
	}	
}
if(pdo_tableexists('weisrc_dish_tpl_log')) {
	if(!pdo_fieldexists('weisrc_dish_tpl_log',  'ordersn')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tpl_log')." ADD `ordersn` varchar(100);");
	}	
}
if(pdo_tableexists('weisrc_dish_tpl_log')) {
	if(!pdo_fieldexists('weisrc_dish_tpl_log',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tpl_log')." ADD `from_user` varchar(100) COMMENT '接收者openid';");
	}	
}
if(pdo_tableexists('weisrc_dish_tpl_log')) {
	if(!pdo_fieldexists('weisrc_dish_tpl_log',  'content')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tpl_log')." ADD `content` varchar(1000) COMMENT '内容';");
	}	
}
if(pdo_tableexists('weisrc_dish_tpl_log')) {
	if(!pdo_fieldexists('weisrc_dish_tpl_log',  'result')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tpl_log')." ADD `result` varchar(200) COMMENT '内容结果';");
	}	
}
if(pdo_tableexists('weisrc_dish_tpl_log')) {
	if(!pdo_fieldexists('weisrc_dish_tpl_log',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_tpl_log')." ADD `dateline` int(10) DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_type')) {
...
if(pdo_tableexists('weisrc_dish_type')) {
	if(!pdo_fieldexists('weisrc_dish_type',  'weid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_type')." ADD `weid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '所属帐号';");
	}	
}
if(pdo_tableexists('weisrc_dish_type')) {
	if(!pdo_fieldexists('weisrc_dish_type',  'name')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_type')." ADD `name` varchar(50) NOT NULL COMMENT '类型名称';");
	}	
}
if(pdo_tableexists('weisrc_dish_type')) {
	if(!pdo_fieldexists('weisrc_dish_type',  'parentid')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_type')." ADD `parentid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '上级分类ID,0为第一级';");
	}	
}
if(pdo_tableexists('weisrc_dish_type')) {
	if(!pdo_fieldexists('weisrc_dish_type',  'displayorder')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_type')." ADD `displayorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '排序';");
	}	
}
if(pdo_tableexists('weisrc_dish_type')) {
	if(!pdo_fieldexists('weisrc_dish_type',  'dateline')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_type')." ADD `dateline` int(10) unsigned NOT NULL DEFAULT '0';");
	}	
}
if(pdo_tableexists('weisrc_dish_type')) {
	if(!pdo_fieldexists('weisrc_dish_type',  'status')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_type')." ADD `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态';");
	}	
}
if(pdo_tableexists('weisrc_dish_type')) {
	if(!pdo_fieldexists('weisrc_dish_type',  'url')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_type')." ADD `url` varchar(200) NOT NULL COMMENT '链接';");
	}	
}
if(pdo_tableexists('weisrc_dish_type')) {
	if(!pdo_fieldexists('weisrc_dish_type',  'thumb')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_type')." ADD `thumb` varchar(500) NOT NULL COMMENT '图片';");
	}	
}
if(pdo_tableexists('weisrc_dish_useraddress')) {
...
if(pdo_tableexists('weisrc_dish_useraddress')) {
	if(!pdo_fieldexists('weisrc_dish_useraddress',  'from_user')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_useraddress')." ADD `from_user` varchar(50) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_useraddress')) {
	if(!pdo_fieldexists('weisrc_dish_useraddress',  'realname')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_useraddress')." ADD `realname` varchar(20) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_useraddress')) {
	if(!pdo_fieldexists('weisrc_dish_useraddress',  'mobile')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_useraddress')." ADD `mobile` varchar(20) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_useraddress')) {
	if(!pdo_fieldexists('weisrc_dish_useraddress',  'address')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_useraddress')." ADD `address` varchar(300) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_useraddress')) {
	if(!pdo_fieldexists('weisrc_dish_useraddress',  'doorplate')) {
		pdo_query("ALTER TABLE ".tablename('weisrc_dish_useraddress')." ADD `doorplate` varchar(300) NOT NULL;");
	}	
}
if(pdo_tableexists('weisrc_dish_useraddress')) {
