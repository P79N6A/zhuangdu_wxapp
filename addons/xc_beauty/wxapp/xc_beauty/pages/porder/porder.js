...
function get_time(e) {
    ...
    if (1 == e.data.time_status && (null == e.data.group || "" == e.data.group) || 1 == e.data.group_time && "" != e.data.group && null != e.data.group) {
...
function sign(t) {
    var a = t.data.time_curr, e = t.data.name, r = t.data.mobile, d = t.data.service_type, s = t.data.store_member, i = t.data.store, n = !0;
    1 == t.data.time_status && -1 == a && (n = !1), "" != e && null != e || (n = !1), 
    "" != r && null != r || (n = !1);
    /^(((13[0-9]{1})|(14[0-9]{1})|(17[0-9]{1})|(15[0-3]{1})|(15[5-9]{1})|(18[0-9]{1}))+\d{8})$/.test(r) || (n = !1), 
    -1 == d && (n = !1), -1 == i && (n = !1), 1 == t.data.member_status && -1 == s && (n = !1), 
    t.setData({
        submit: n
    });
}
