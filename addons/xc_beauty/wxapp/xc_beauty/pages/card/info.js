...
function sign(a) {
    ...
    /^(((13[0-9]{1})|(14[0-9]{1})|(17[0-9]{1})|(15[0-3]{1})|(15[5-9]{1})|(18[0-9]{1}))+\d{8})$/.test(e) || (s = !1);
    var d = a.data.card;
...
Page({
    ...
    getcode: function() {
        ...
        t.data.isload || ("" != a && null != a && /^(((13[0-9]{1})|(14[0-9]{1})|(17[0-9]{1})|(15[0-3]{1})|(15[5-9]{1})|(18[0-9]{1}))+\d{8})$/.test(a) ? app.util.request({
