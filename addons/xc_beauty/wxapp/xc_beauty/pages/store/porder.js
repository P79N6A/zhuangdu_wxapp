...
function sign(a) {
    ...
    "" != d && null != d || (n = !1);
    /^(((13[0-9]{1})|(14[0-9]{1})|(17[0-9]{1})|(15[0-3]{1})|(15[5-9]{1})|(18[0-9]{1}))+\d{8})$/.test(d) || (n = !1), 
    -1 == r && (n = !1), "" != i && null != i && "" != s && null != s || (n = !1), a.setData({
        submit: n
    });
}
...
Page({
    ...
    onLoad: function(e) {
        ...
        for (var a = [], t = 0; t < 5; t++) {
            (r = {}).index = t, r.date = GetDateStr(t), r.week = getMyDay(t), r.name = 0 == t ? "今天" : getMyDay2(t), 
            a.push(r);
        }
        if (d.setData({
            date: a
            ...
            var i = app.map, s = -1;
            null != i && "" != i && "" != i.content && null != i.content && 1 == i.content.store && (s = ""), 
            d.setData({
                id: s,
                map: i
            });
        ...
        "" != d.data.id && null != d.data.id && -1 != d.data.id && (r.id = d.data.id), app.util.request({
