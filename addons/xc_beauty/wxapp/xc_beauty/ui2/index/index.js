...
Page({
                ...
                if ("" != t.data) {
                    if ("" != t.data.banner && null != t.data.banner && l.setData({
                        ...
                        for (var n = t.data.flash, e = 0; e < n.length; e++) {
                            ...
                            i = parseInt((n[e].fail - 86400 * o - 3600 * s) / 60), d = parseInt(n[e].fail % 60), 
                            n[e].day = o, n[e].hour = s, n[e].min = i, n[e].second = d;
                        }
                        l.setData({
                            flash: n
                        }), time_up(l);
    ...
    onShareAppMessage: function() {
        ...
        1 == s && (o = o + "&scene=" + app.userinfo.openid), console.log(o), {
            title: n,
            path: o,
            imageUrl: e,
            success: function(a) {
