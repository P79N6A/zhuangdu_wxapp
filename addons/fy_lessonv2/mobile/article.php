...
if($op=='display'){
	...
	$list = pdo_fetchall("SELECT * FROM " . tablename($this->table_article) . " WHERE uniacid=:uniacid ORDER BY displayorder DESC  LIMIT " . ($pindex-1) * $psize . ',' . $psize, array(':uniacid'=>$uniacid));
